...
import com.resource.server.service.dto.CurrencyCriteria;
import com.resource.server.service.CurrencyQueryService;
...
/**
 * REST controller for managing {@link com.resource.server.domain.Currency}.
 */
@RestController
@RequestMapping("/api")
