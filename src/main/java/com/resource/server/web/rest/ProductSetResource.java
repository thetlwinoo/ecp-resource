...
import com.resource.server.service.dto.ProductSetCriteria;
import com.resource.server.service.ProductSetQueryService;
...
/**
 * REST controller for managing {@link com.resource.server.domain.ProductSet}.
 */
@RestController
@RequestMapping("/api")
