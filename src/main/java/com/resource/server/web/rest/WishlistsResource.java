...
import com.resource.server.service.dto.WishlistsCriteria;
import com.resource.server.service.WishlistsQueryService;
...
/**
 * REST controller for managing {@link com.resource.server.domain.Wishlists}.
 */
@RestController
@RequestMapping("/api")
