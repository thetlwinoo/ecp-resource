...
import com.resource.server.service.dto.ComparesCriteria;
import com.resource.server.service.ComparesQueryService;
...
/**
 * REST controller for managing {@link com.resource.server.domain.Compares}.
 */
@RestController
@RequestMapping("/api")
