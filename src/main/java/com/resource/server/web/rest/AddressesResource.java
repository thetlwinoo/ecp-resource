...
import com.resource.server.service.dto.AddressesCriteria;
import com.resource.server.service.AddressesQueryService;
...
/**
 * REST controller for managing {@link com.resource.server.domain.Addresses}.
 */
@RestController
@RequestMapping("/api")
