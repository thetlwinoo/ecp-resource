...
import com.resource.server.service.dto.ShipMethodCriteria;
import com.resource.server.service.ShipMethodQueryService;
...
/**
 * REST controller for managing {@link com.resource.server.domain.ShipMethod}.
 */
@RestController
@RequestMapping("/api")
