...
import com.resource.server.service.CompareProductsExtendService;
...
public class CompareProductsExtendServiceImpl implements CompareProductsExtendService {
    ...
    public CompareProductsExtendServiceImpl(ComparesRepository comparesRepository, CompareProductsRepository compareProductsRepository, PeopleExtendRepository peopleExtendRepository, ProductsRepository productsRepository) {
