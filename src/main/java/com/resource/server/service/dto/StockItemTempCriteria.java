...
/**
 * Criteria class for the {@link com.resource.server.domain.StockItemTemp} entity. This class is used
 * in {@link com.resource.server.web.rest.StockItemTempResource} to receive all the possible filtering options from
...
public class StockItemTempCriteria implements Serializable, Criteria {
    ...
    private FloatFilter remommendedRetailPrice;
    ...
    public FloatFilter getRemommendedRetailPrice() {
        return remommendedRetailPrice;
    }

    public void setRemommendedRetailPrice(FloatFilter remommendedRetailPrice) {
