...
/**
 * Criteria class for the {@link com.resource.server.domain.StockItemTransactions} entity. This class is used
 * in {@link com.resource.server.web.rest.StockItemTransactionsResource} to receive all the possible filtering options from
...
public class StockItemTransactionsCriteria implements Serializable, Criteria {
    ...
    private LocalDateFilter transactionOccurredWhen;
    ...
    public LocalDateFilter getTransactionOccurredWhen() {
        return transactionOccurredWhen;
    }

    public void setTransactionOccurredWhen(LocalDateFilter transactionOccurredWhen) {
