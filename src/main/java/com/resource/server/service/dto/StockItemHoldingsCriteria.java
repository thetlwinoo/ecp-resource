...
/**
 * Criteria class for the {@link com.resource.server.domain.StockItemHoldings} entity. This class is used
 * in {@link com.resource.server.web.rest.StockItemHoldingsResource} to receive all the possible filtering options from
...
public class StockItemHoldingsCriteria implements Serializable, Criteria {
    ...
    private FloatFilter lastCostPrice;
    ...
    public FloatFilter getLastCostPrice() {
        return lastCostPrice;
    }

    public void setLastCostPrice(FloatFilter lastCostPrice) {
