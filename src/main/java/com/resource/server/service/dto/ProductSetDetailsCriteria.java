...
/**
 * Criteria class for the {@link com.resource.server.domain.ProductSetDetails} entity. This class is used
 * in {@link com.resource.server.web.rest.ProductSetDetailsResource} to receive all the possible filtering options from
...
public class ProductSetDetailsCriteria implements Serializable, Criteria {
    ...
    private FloatFilter subGroupMinTotal;
    ...
    public FloatFilter getSubGroupMinTotal() {
        return subGroupMinTotal;
    }

    public void setSubGroupMinTotal(FloatFilter subGroupMinTotal) {
