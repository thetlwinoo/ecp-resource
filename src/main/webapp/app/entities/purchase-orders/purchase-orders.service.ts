...
export class PurchaseOrdersService {
  ...
  protected convertDateFromClient(purchaseOrders: IPurchaseOrders): IPurchaseOrders {
    const copy: IPurchaseOrders = Object.assign({}, purchaseOrders, {
      orderDate:
        purchaseOrders.orderDate != null && purchaseOrders.orderDate.isValid() ? purchaseOrders.orderDate.format(DATE_FORMAT) : null,
      expectedDeliveryDate:
        purchaseOrders.expectedDeliveryDate != null && purchaseOrders.expectedDeliveryDate.isValid()
          ...
          : null,
      lastEditedWhen:
        purchaseOrders.lastEditedWhen != null && purchaseOrders.lastEditedWhen.isValid()
          ? purchaseOrders.lastEditedWhen.format(DATE_FORMAT)
          : null
    });
    return copy;
  }
