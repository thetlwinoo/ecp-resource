    ...
    const copy: IStockItemTemp = Object.assign({}, stockItemTemp, {
      sellStartDate:
        stockItemTemp.sellStartDate != null && stockItemTemp.sellStartDate.isValid()
          ...
          : null,
      sellEndDate:
        stockItemTemp.sellEndDate != null && stockItemTemp.sellEndDate.isValid() ? stockItemTemp.sellEndDate.format(DATE_FORMAT) : null,
      lastEditedWhen:
        stockItemTemp.lastEditedWhen != null && stockItemTemp.lastEditedWhen.isValid()
          ? stockItemTemp.lastEditedWhen.format(DATE_FORMAT)
          : null
    });
    return copy;
  }
