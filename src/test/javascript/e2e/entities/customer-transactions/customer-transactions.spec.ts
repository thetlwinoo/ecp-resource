...
describe('CustomerTransactions e2e test', () => {
  ...
  it('should create and save CustomerTransactions', async () => {
    ...
    await promise.all([
      ...
      customerTransactionsUpdatePage.setLastEditedWhenInput('2000-12-31'),
    ...
    expect(await customerTransactionsUpdatePage.getTransactionDateInput()).to.eq(
      '2000-12-31',
    ...
    expect(await customerTransactionsUpdatePage.getFinalizationDateInput()).to.eq(
      '2000-12-31',
    ...
    expect(await customerTransactionsUpdatePage.getLastEditedWhenInput()).to.eq(
      '2000-12-31',
