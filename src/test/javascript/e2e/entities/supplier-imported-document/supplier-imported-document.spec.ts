...
describe('SupplierImportedDocument e2e test', () => {
  ...
  it('should load create SupplierImportedDocument page', async () => {
    ...
    expect(await supplierImportedDocumentUpdatePage.getPageTitle()).to.eq('resourceApp.supplierImportedDocument.home.createOrEditLabel');
  ...
  it('should create and save SupplierImportedDocuments', async () => {
    ...
    await promise.all([
      ...
      supplierImportedDocumentUpdatePage.setLastEditedWhenInput('2000-12-31'),
    ...
    expect(await supplierImportedDocumentUpdatePage.getLastEditedWhenInput()).to.eq(
      '2000-12-31',
