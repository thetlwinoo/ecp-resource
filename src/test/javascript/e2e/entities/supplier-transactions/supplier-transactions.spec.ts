...
describe('SupplierTransactions e2e test', () => {
  ...
  it('should create and save SupplierTransactions', async () => {
    ...
    await promise.all([
      ...
      supplierTransactionsUpdatePage.setLastEditedWhenInput('2000-12-31'),
    ...
    expect(await supplierTransactionsUpdatePage.getTransactionDateInput()).to.eq(
      '2000-12-31',
    ...
    expect(await supplierTransactionsUpdatePage.getFinalizationDateInput()).to.eq(
      '2000-12-31',
    ...
    expect(await supplierTransactionsUpdatePage.getLastEditedWhenInput()).to.eq(
      '2000-12-31',
