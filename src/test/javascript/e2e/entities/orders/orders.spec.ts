...
describe('Orders e2e test', () => {
  ...
  it('should create and save Orders', async () => {
    ...
    await promise.all([
      ...
      ordersUpdatePage.setLastEditedWhenInput('2000-12-31'),
    ...
    expect(await ordersUpdatePage.getPickingCompletedWhenInput()).to.eq(
      '2000-12-31',
    ...
    expect(await ordersUpdatePage.getLastEditedWhenInput()).to.eq('2000-12-31', 'Expected lastEditedWhen value to be equals to 2000-12-31');
