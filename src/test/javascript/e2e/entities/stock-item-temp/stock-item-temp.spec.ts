...
describe('StockItemTemp e2e test', () => {
  ...
  it('should create and save StockItemTemps', async () => {
    ...
    await promise.all([
      ...
      stockItemTempUpdatePage.setLastEditedWhenInput('2000-12-31'),
    ...
    expect(await stockItemTempUpdatePage.getSellStartDateInput()).to.eq(
      '2000-12-31',
      'Expected sellStartDate value to be equals to 2000-12-31'
    );
    expect(await stockItemTempUpdatePage.getSellEndDateInput()).to.eq(
      '2000-12-31',
    ...
    expect(await stockItemTempUpdatePage.getLastEditedWhenInput()).to.eq(
      '2000-12-31',
