...
describe('PurchaseOrders e2e test', () => {
  ...
  it('should create and save PurchaseOrders', async () => {
    ...
    await promise.all([
      ...
      purchaseOrdersUpdatePage.setLastEditedWhenInput('2000-12-31'),
    ...
    expect(await purchaseOrdersUpdatePage.getOrderDateInput()).to.eq('2000-12-31', 'Expected orderDate value to be equals to 2000-12-31');
    ...
    expect(await purchaseOrdersUpdatePage.getLastEditedWhenInput()).to.eq(
      '2000-12-31',
