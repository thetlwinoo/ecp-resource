...
describe('Invoices e2e test', () => {
  ...
  it('should create and save Invoices', async () => {
    ...
    await promise.all([
      ...
      invoicesUpdatePage.setLastEditedWhenInput('2000-12-31'),
    ...
    expect(await invoicesUpdatePage.getInvoiceDateInput()).to.eq('2000-12-31', 'Expected invoiceDate value to be equals to 2000-12-31');
    ...
    expect(await invoicesUpdatePage.getLastEditedWhenInput()).to.eq(
      '2000-12-31',
