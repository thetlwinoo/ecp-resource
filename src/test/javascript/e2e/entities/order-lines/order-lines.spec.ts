...
describe('OrderLines e2e test', () => {
  ...
  it('should create and save OrderLines', async () => {
    ...
    await promise.all([
      ...
      orderLinesUpdatePage.setLastEditedWhenInput('2000-12-31'),
    ...
    expect(await orderLinesUpdatePage.getPickingCompletedWhenInput()).to.eq(
      '2000-12-31',
    ...
    expect(await orderLinesUpdatePage.getLastEditedWhenInput()).to.eq(
      '2000-12-31',
