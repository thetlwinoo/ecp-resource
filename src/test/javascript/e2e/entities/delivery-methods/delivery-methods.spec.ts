...
describe('DeliveryMethods e2e test', () => {
  ...
  it('should create and save DeliveryMethods', async () => {
    ...
    expect(await deliveryMethodsUpdatePage.getValidFromInput()).to.eq('2000-12-31', 'Expected validFrom value to be equals to 2000-12-31');
    expect(await deliveryMethodsUpdatePage.getValidToInput()).to.eq('2000-12-31', 'Expected validTo value to be equals to 2000-12-31');
