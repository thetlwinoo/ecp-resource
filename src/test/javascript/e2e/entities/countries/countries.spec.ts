...
describe('Countries e2e test', () => {
  ...
  it('should create and save Countries', async () => {
    ...
    expect(await countriesUpdatePage.getValidFromInput()).to.eq('2000-12-31', 'Expected validFrom value to be equals to 2000-12-31');
    expect(await countriesUpdatePage.getValidToInput()).to.eq('2000-12-31', 'Expected validTo value to be equals to 2000-12-31');
