...
describe('StockItems e2e test', () => {
  ...
  it('should create and save StockItems', async () => {
    ...
    await promise.all([
      ...
      stockItemsUpdatePage.setLastEditedWhenInput('2000-12-31'),
    ...
    expect(await stockItemsUpdatePage.getSellStartDateInput()).to.eq(
      '2000-12-31',
      'Expected sellStartDate value to be equals to 2000-12-31'
    );
    expect(await stockItemsUpdatePage.getSellEndDateInput()).to.eq('2000-12-31', 'Expected sellEndDate value to be equals to 2000-12-31');
    ...
    expect(await stockItemsUpdatePage.getLastEditedWhenInput()).to.eq(
      '2000-12-31',
