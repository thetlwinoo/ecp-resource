...
import com.resource.server.service.dto.CitiesCriteria;
import com.resource.server.service.CitiesQueryService;
...
public class CitiesResourceIT {
    ...
    @Test
    @Transactional
    public void getAllCitiesByValidFromIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        citiesRepository.saveAndFlush(cities);

        // Get all the citiesList where validFrom is greater than or equal to DEFAULT_VALID_FROM
        defaultCitiesShouldBeFound("validFrom.greaterThanOrEqual=" + DEFAULT_VALID_FROM);

        // Get all the citiesList where validFrom is greater than or equal to UPDATED_VALID_FROM
        defaultCitiesShouldNotBeFound("validFrom.greaterThanOrEqual=" + UPDATED_VALID_FROM);
    }

    @Test
    @Transactional
    public void getAllCitiesByValidFromIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        citiesRepository.saveAndFlush(cities);

        // Get all the citiesList where validFrom is less than or equal to DEFAULT_VALID_FROM
        defaultCitiesShouldBeFound("validFrom.lessThanOrEqual=" + DEFAULT_VALID_FROM);

        // Get all the citiesList where validFrom is less than or equal to SMALLER_VALID_FROM
        defaultCitiesShouldNotBeFound("validFrom.lessThanOrEqual=" + SMALLER_VALID_FROM);
    }

    @Test
    @Transactional
    public void getAllCitiesByValidFromIsLessThanSomething() throws Exception {
        // Initialize the database
        citiesRepository.saveAndFlush(cities);

        // Get all the citiesList where validFrom is less than DEFAULT_VALID_FROM
        defaultCitiesShouldNotBeFound("validFrom.lessThan=" + DEFAULT_VALID_FROM);

        // Get all the citiesList where validFrom is less than UPDATED_VALID_FROM
        defaultCitiesShouldBeFound("validFrom.lessThan=" + UPDATED_VALID_FROM);
    }

    @Test
    @Transactional
    public void getAllCitiesByValidFromIsGreaterThanSomething() throws Exception {
        // Initialize the database
        citiesRepository.saveAndFlush(cities);

        // Get all the citiesList where validFrom is greater than DEFAULT_VALID_FROM
        defaultCitiesShouldNotBeFound("validFrom.greaterThan=" + DEFAULT_VALID_FROM);

        // Get all the citiesList where validFrom is greater than SMALLER_VALID_FROM
        defaultCitiesShouldBeFound("validFrom.greaterThan=" + SMALLER_VALID_FROM);
    }
    ...
    @Test
    @Transactional
    public void getAllCitiesByValidToIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        citiesRepository.saveAndFlush(cities);

        // Get all the citiesList where validTo is greater than or equal to DEFAULT_VALID_TO
        defaultCitiesShouldBeFound("validTo.greaterThanOrEqual=" + DEFAULT_VALID_TO);

        // Get all the citiesList where validTo is greater than or equal to UPDATED_VALID_TO
        defaultCitiesShouldNotBeFound("validTo.greaterThanOrEqual=" + UPDATED_VALID_TO);
    }

    @Test
    @Transactional
    public void getAllCitiesByValidToIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        citiesRepository.saveAndFlush(cities);

        // Get all the citiesList where validTo is less than or equal to DEFAULT_VALID_TO
        defaultCitiesShouldBeFound("validTo.lessThanOrEqual=" + DEFAULT_VALID_TO);

        // Get all the citiesList where validTo is less than or equal to SMALLER_VALID_TO
        defaultCitiesShouldNotBeFound("validTo.lessThanOrEqual=" + SMALLER_VALID_TO);
    }

    @Test
    @Transactional
    public void getAllCitiesByValidToIsLessThanSomething() throws Exception {
        // Initialize the database
        citiesRepository.saveAndFlush(cities);

        // Get all the citiesList where validTo is less than DEFAULT_VALID_TO
        defaultCitiesShouldNotBeFound("validTo.lessThan=" + DEFAULT_VALID_TO);

        // Get all the citiesList where validTo is less than UPDATED_VALID_TO
        defaultCitiesShouldBeFound("validTo.lessThan=" + UPDATED_VALID_TO);
    }

    @Test
    @Transactional
    public void getAllCitiesByValidToIsGreaterThanSomething() throws Exception {
        // Initialize the database
        citiesRepository.saveAndFlush(cities);

        // Get all the citiesList where validTo is greater than DEFAULT_VALID_TO
        defaultCitiesShouldNotBeFound("validTo.greaterThan=" + DEFAULT_VALID_TO);

        // Get all the citiesList where validTo is greater than SMALLER_VALID_TO
        defaultCitiesShouldBeFound("validTo.greaterThan=" + SMALLER_VALID_TO);
    }
