...
import com.resource.server.service.dto.PeopleCriteria;
import com.resource.server.service.PeopleQueryService;
...
public class PeopleResourceIT {
    ...
    @Test
    @Transactional
    public void getAllPeopleByValidFromIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        peopleRepository.saveAndFlush(people);

        // Get all the peopleList where validFrom is greater than or equal to DEFAULT_VALID_FROM
        defaultPeopleShouldBeFound("validFrom.greaterThanOrEqual=" + DEFAULT_VALID_FROM);

        // Get all the peopleList where validFrom is greater than or equal to UPDATED_VALID_FROM
        defaultPeopleShouldNotBeFound("validFrom.greaterThanOrEqual=" + UPDATED_VALID_FROM);
    }

    @Test
    @Transactional
    public void getAllPeopleByValidFromIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        peopleRepository.saveAndFlush(people);

        // Get all the peopleList where validFrom is less than or equal to DEFAULT_VALID_FROM
        defaultPeopleShouldBeFound("validFrom.lessThanOrEqual=" + DEFAULT_VALID_FROM);

        // Get all the peopleList where validFrom is less than or equal to SMALLER_VALID_FROM
        defaultPeopleShouldNotBeFound("validFrom.lessThanOrEqual=" + SMALLER_VALID_FROM);
    }

    @Test
    @Transactional
    public void getAllPeopleByValidFromIsLessThanSomething() throws Exception {
        // Initialize the database
        peopleRepository.saveAndFlush(people);

        // Get all the peopleList where validFrom is less than DEFAULT_VALID_FROM
        defaultPeopleShouldNotBeFound("validFrom.lessThan=" + DEFAULT_VALID_FROM);

        // Get all the peopleList where validFrom is less than UPDATED_VALID_FROM
        defaultPeopleShouldBeFound("validFrom.lessThan=" + UPDATED_VALID_FROM);
    }

    @Test
    @Transactional
    public void getAllPeopleByValidFromIsGreaterThanSomething() throws Exception {
        // Initialize the database
        peopleRepository.saveAndFlush(people);

        // Get all the peopleList where validFrom is greater than DEFAULT_VALID_FROM
        defaultPeopleShouldNotBeFound("validFrom.greaterThan=" + DEFAULT_VALID_FROM);

        // Get all the peopleList where validFrom is greater than SMALLER_VALID_FROM
        defaultPeopleShouldBeFound("validFrom.greaterThan=" + SMALLER_VALID_FROM);
    }
    ...
    @Test
    @Transactional
    public void getAllPeopleByValidToIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        peopleRepository.saveAndFlush(people);

        // Get all the peopleList where validTo is greater than or equal to DEFAULT_VALID_TO
        defaultPeopleShouldBeFound("validTo.greaterThanOrEqual=" + DEFAULT_VALID_TO);

        // Get all the peopleList where validTo is greater than or equal to UPDATED_VALID_TO
        defaultPeopleShouldNotBeFound("validTo.greaterThanOrEqual=" + UPDATED_VALID_TO);
    }

    @Test
    @Transactional
    public void getAllPeopleByValidToIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        peopleRepository.saveAndFlush(people);

        // Get all the peopleList where validTo is less than or equal to DEFAULT_VALID_TO
        defaultPeopleShouldBeFound("validTo.lessThanOrEqual=" + DEFAULT_VALID_TO);

        // Get all the peopleList where validTo is less than or equal to SMALLER_VALID_TO
        defaultPeopleShouldNotBeFound("validTo.lessThanOrEqual=" + SMALLER_VALID_TO);
    }

    @Test
    @Transactional
    public void getAllPeopleByValidToIsLessThanSomething() throws Exception {
        // Initialize the database
        peopleRepository.saveAndFlush(people);

        // Get all the peopleList where validTo is less than DEFAULT_VALID_TO
        defaultPeopleShouldNotBeFound("validTo.lessThan=" + DEFAULT_VALID_TO);

        // Get all the peopleList where validTo is less than UPDATED_VALID_TO
        defaultPeopleShouldBeFound("validTo.lessThan=" + UPDATED_VALID_TO);
    }

    @Test
    @Transactional
    public void getAllPeopleByValidToIsGreaterThanSomething() throws Exception {
        // Initialize the database
        peopleRepository.saveAndFlush(people);

        // Get all the peopleList where validTo is greater than DEFAULT_VALID_TO
        defaultPeopleShouldNotBeFound("validTo.greaterThan=" + DEFAULT_VALID_TO);

        // Get all the peopleList where validTo is greater than SMALLER_VALID_TO
        defaultPeopleShouldBeFound("validTo.greaterThan=" + SMALLER_VALID_TO);
    }
