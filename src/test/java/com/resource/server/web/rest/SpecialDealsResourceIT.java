...
import com.resource.server.service.dto.SpecialDealsCriteria;
import com.resource.server.service.SpecialDealsQueryService;
...
public class SpecialDealsResourceIT {
    ...
    private static final Float SMALLER_DISCOUNT_AMOUNT = 1F - 1F;
    ...
    @Test
    @Transactional
    public void getAllSpecialDealsByStartDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        specialDealsRepository.saveAndFlush(specialDeals);

        // Get all the specialDealsList where startDate is greater than or equal to DEFAULT_START_DATE
        defaultSpecialDealsShouldBeFound("startDate.greaterThanOrEqual=" + DEFAULT_START_DATE);

        // Get all the specialDealsList where startDate is greater than or equal to UPDATED_START_DATE
        defaultSpecialDealsShouldNotBeFound("startDate.greaterThanOrEqual=" + UPDATED_START_DATE);
    }

    @Test
    @Transactional
    public void getAllSpecialDealsByStartDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        specialDealsRepository.saveAndFlush(specialDeals);

        // Get all the specialDealsList where startDate is less than or equal to DEFAULT_START_DATE
        defaultSpecialDealsShouldBeFound("startDate.lessThanOrEqual=" + DEFAULT_START_DATE);

        // Get all the specialDealsList where startDate is less than or equal to SMALLER_START_DATE
        defaultSpecialDealsShouldNotBeFound("startDate.lessThanOrEqual=" + SMALLER_START_DATE);
    }

    @Test
    @Transactional
    public void getAllSpecialDealsByStartDateIsLessThanSomething() throws Exception {
        // Initialize the database
        specialDealsRepository.saveAndFlush(specialDeals);

        // Get all the specialDealsList where startDate is less than DEFAULT_START_DATE
        defaultSpecialDealsShouldNotBeFound("startDate.lessThan=" + DEFAULT_START_DATE);

        // Get all the specialDealsList where startDate is less than UPDATED_START_DATE
        defaultSpecialDealsShouldBeFound("startDate.lessThan=" + UPDATED_START_DATE);
    }

    @Test
    @Transactional
    public void getAllSpecialDealsByStartDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        specialDealsRepository.saveAndFlush(specialDeals);

        // Get all the specialDealsList where startDate is greater than DEFAULT_START_DATE
        defaultSpecialDealsShouldNotBeFound("startDate.greaterThan=" + DEFAULT_START_DATE);

        // Get all the specialDealsList where startDate is greater than SMALLER_START_DATE
        defaultSpecialDealsShouldBeFound("startDate.greaterThan=" + SMALLER_START_DATE);
    }
    ...
    @Test
    @Transactional
    public void getAllSpecialDealsByEndDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        specialDealsRepository.saveAndFlush(specialDeals);

        // Get all the specialDealsList where endDate is greater than or equal to DEFAULT_END_DATE
        defaultSpecialDealsShouldBeFound("endDate.greaterThanOrEqual=" + DEFAULT_END_DATE);

        // Get all the specialDealsList where endDate is greater than or equal to UPDATED_END_DATE
        defaultSpecialDealsShouldNotBeFound("endDate.greaterThanOrEqual=" + UPDATED_END_DATE);
    }

    @Test
    @Transactional
    public void getAllSpecialDealsByEndDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        specialDealsRepository.saveAndFlush(specialDeals);

        // Get all the specialDealsList where endDate is less than or equal to DEFAULT_END_DATE
        defaultSpecialDealsShouldBeFound("endDate.lessThanOrEqual=" + DEFAULT_END_DATE);

        // Get all the specialDealsList where endDate is less than or equal to SMALLER_END_DATE
        defaultSpecialDealsShouldNotBeFound("endDate.lessThanOrEqual=" + SMALLER_END_DATE);
    }

    @Test
    @Transactional
    public void getAllSpecialDealsByEndDateIsLessThanSomething() throws Exception {
        // Initialize the database
        specialDealsRepository.saveAndFlush(specialDeals);

        // Get all the specialDealsList where endDate is less than DEFAULT_END_DATE
        defaultSpecialDealsShouldNotBeFound("endDate.lessThan=" + DEFAULT_END_DATE);

        // Get all the specialDealsList where endDate is less than UPDATED_END_DATE
        defaultSpecialDealsShouldBeFound("endDate.lessThan=" + UPDATED_END_DATE);
    }

    @Test
    @Transactional
    public void getAllSpecialDealsByEndDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        specialDealsRepository.saveAndFlush(specialDeals);

        // Get all the specialDealsList where endDate is greater than DEFAULT_END_DATE
        defaultSpecialDealsShouldNotBeFound("endDate.greaterThan=" + DEFAULT_END_DATE);

        // Get all the specialDealsList where endDate is greater than SMALLER_END_DATE
        defaultSpecialDealsShouldBeFound("endDate.greaterThan=" + SMALLER_END_DATE);
    }
    ...
    @Test
    @Transactional
    public void getAllSpecialDealsByLastEditedWhenIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        specialDealsRepository.saveAndFlush(specialDeals);

        // Get all the specialDealsList where lastEditedWhen is greater than or equal to DEFAULT_LAST_EDITED_WHEN
        defaultSpecialDealsShouldBeFound("lastEditedWhen.greaterThanOrEqual=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the specialDealsList where lastEditedWhen is greater than or equal to UPDATED_LAST_EDITED_WHEN
        defaultSpecialDealsShouldNotBeFound("lastEditedWhen.greaterThanOrEqual=" + UPDATED_LAST_EDITED_WHEN);
    }

    @Test
    @Transactional
    public void getAllSpecialDealsByLastEditedWhenIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        specialDealsRepository.saveAndFlush(specialDeals);

        // Get all the specialDealsList where lastEditedWhen is less than or equal to DEFAULT_LAST_EDITED_WHEN
        defaultSpecialDealsShouldBeFound("lastEditedWhen.lessThanOrEqual=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the specialDealsList where lastEditedWhen is less than or equal to SMALLER_LAST_EDITED_WHEN
        defaultSpecialDealsShouldNotBeFound("lastEditedWhen.lessThanOrEqual=" + SMALLER_LAST_EDITED_WHEN);
    }

    @Test
    @Transactional
    public void getAllSpecialDealsByLastEditedWhenIsLessThanSomething() throws Exception {
        // Initialize the database
        specialDealsRepository.saveAndFlush(specialDeals);

        // Get all the specialDealsList where lastEditedWhen is less than DEFAULT_LAST_EDITED_WHEN
        defaultSpecialDealsShouldNotBeFound("lastEditedWhen.lessThan=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the specialDealsList where lastEditedWhen is less than UPDATED_LAST_EDITED_WHEN
        defaultSpecialDealsShouldBeFound("lastEditedWhen.lessThan=" + UPDATED_LAST_EDITED_WHEN);
    }

    @Test
    @Transactional
    public void getAllSpecialDealsByLastEditedWhenIsGreaterThanSomething() throws Exception {
        // Initialize the database
        specialDealsRepository.saveAndFlush(specialDeals);

        // Get all the specialDealsList where lastEditedWhen is greater than DEFAULT_LAST_EDITED_WHEN
        defaultSpecialDealsShouldNotBeFound("lastEditedWhen.greaterThan=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the specialDealsList where lastEditedWhen is greater than SMALLER_LAST_EDITED_WHEN
        defaultSpecialDealsShouldBeFound("lastEditedWhen.greaterThan=" + SMALLER_LAST_EDITED_WHEN);
    }
