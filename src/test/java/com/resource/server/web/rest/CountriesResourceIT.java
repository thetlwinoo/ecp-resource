...
import com.resource.server.service.dto.CountriesCriteria;
import com.resource.server.service.CountriesQueryService;
...
public class CountriesResourceIT {
    ...
    @Test
    @Transactional
    public void getAllCountriesByValidFromIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        countriesRepository.saveAndFlush(countries);

        // Get all the countriesList where validFrom is greater than or equal to DEFAULT_VALID_FROM
        defaultCountriesShouldBeFound("validFrom.greaterThanOrEqual=" + DEFAULT_VALID_FROM);

        // Get all the countriesList where validFrom is greater than or equal to UPDATED_VALID_FROM
        defaultCountriesShouldNotBeFound("validFrom.greaterThanOrEqual=" + UPDATED_VALID_FROM);
    }

    @Test
    @Transactional
    public void getAllCountriesByValidFromIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        countriesRepository.saveAndFlush(countries);

        // Get all the countriesList where validFrom is less than or equal to DEFAULT_VALID_FROM
        defaultCountriesShouldBeFound("validFrom.lessThanOrEqual=" + DEFAULT_VALID_FROM);

        // Get all the countriesList where validFrom is less than or equal to SMALLER_VALID_FROM
        defaultCountriesShouldNotBeFound("validFrom.lessThanOrEqual=" + SMALLER_VALID_FROM);
    }

    @Test
    @Transactional
    public void getAllCountriesByValidFromIsLessThanSomething() throws Exception {
        // Initialize the database
        countriesRepository.saveAndFlush(countries);

        // Get all the countriesList where validFrom is less than DEFAULT_VALID_FROM
        defaultCountriesShouldNotBeFound("validFrom.lessThan=" + DEFAULT_VALID_FROM);

        // Get all the countriesList where validFrom is less than UPDATED_VALID_FROM
        defaultCountriesShouldBeFound("validFrom.lessThan=" + UPDATED_VALID_FROM);
    }

    @Test
    @Transactional
    public void getAllCountriesByValidFromIsGreaterThanSomething() throws Exception {
        // Initialize the database
        countriesRepository.saveAndFlush(countries);

        // Get all the countriesList where validFrom is greater than DEFAULT_VALID_FROM
        defaultCountriesShouldNotBeFound("validFrom.greaterThan=" + DEFAULT_VALID_FROM);

        // Get all the countriesList where validFrom is greater than SMALLER_VALID_FROM
        defaultCountriesShouldBeFound("validFrom.greaterThan=" + SMALLER_VALID_FROM);
    }
    ...
    @Test
    @Transactional
    public void getAllCountriesByValidToIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        countriesRepository.saveAndFlush(countries);

        // Get all the countriesList where validTo is greater than or equal to DEFAULT_VALID_TO
        defaultCountriesShouldBeFound("validTo.greaterThanOrEqual=" + DEFAULT_VALID_TO);

        // Get all the countriesList where validTo is greater than or equal to UPDATED_VALID_TO
        defaultCountriesShouldNotBeFound("validTo.greaterThanOrEqual=" + UPDATED_VALID_TO);
    }

    @Test
    @Transactional
    public void getAllCountriesByValidToIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        countriesRepository.saveAndFlush(countries);

        // Get all the countriesList where validTo is less than or equal to DEFAULT_VALID_TO
        defaultCountriesShouldBeFound("validTo.lessThanOrEqual=" + DEFAULT_VALID_TO);

        // Get all the countriesList where validTo is less than or equal to SMALLER_VALID_TO
        defaultCountriesShouldNotBeFound("validTo.lessThanOrEqual=" + SMALLER_VALID_TO);
    }

    @Test
    @Transactional
    public void getAllCountriesByValidToIsLessThanSomething() throws Exception {
        // Initialize the database
        countriesRepository.saveAndFlush(countries);

        // Get all the countriesList where validTo is less than DEFAULT_VALID_TO
        defaultCountriesShouldNotBeFound("validTo.lessThan=" + DEFAULT_VALID_TO);

        // Get all the countriesList where validTo is less than UPDATED_VALID_TO
        defaultCountriesShouldBeFound("validTo.lessThan=" + UPDATED_VALID_TO);
    }

    @Test
    @Transactional
    public void getAllCountriesByValidToIsGreaterThanSomething() throws Exception {
        // Initialize the database
        countriesRepository.saveAndFlush(countries);

        // Get all the countriesList where validTo is greater than DEFAULT_VALID_TO
        defaultCountriesShouldNotBeFound("validTo.greaterThan=" + DEFAULT_VALID_TO);

        // Get all the countriesList where validTo is greater than SMALLER_VALID_TO
        defaultCountriesShouldBeFound("validTo.greaterThan=" + SMALLER_VALID_TO);
    }
