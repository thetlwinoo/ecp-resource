...
import com.resource.server.service.dto.SupplierTransactionsCriteria;
import com.resource.server.service.SupplierTransactionsQueryService;
...
public class SupplierTransactionsResourceIT {
    ...
    private static final LocalDate SMALLER_FINALIZATION_DATE = LocalDate.ofEpochDay(-1L);
    ...
    @Test
    @Transactional
    public void getAllSupplierTransactionsByTransactionDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        supplierTransactionsRepository.saveAndFlush(supplierTransactions);

        // Get all the supplierTransactionsList where transactionDate is greater than or equal to DEFAULT_TRANSACTION_DATE
        defaultSupplierTransactionsShouldBeFound("transactionDate.greaterThanOrEqual=" + DEFAULT_TRANSACTION_DATE);

        // Get all the supplierTransactionsList where transactionDate is greater than or equal to UPDATED_TRANSACTION_DATE
        defaultSupplierTransactionsShouldNotBeFound("transactionDate.greaterThanOrEqual=" + UPDATED_TRANSACTION_DATE);
    }

    @Test
    @Transactional
    public void getAllSupplierTransactionsByTransactionDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        supplierTransactionsRepository.saveAndFlush(supplierTransactions);

        // Get all the supplierTransactionsList where transactionDate is less than or equal to DEFAULT_TRANSACTION_DATE
        defaultSupplierTransactionsShouldBeFound("transactionDate.lessThanOrEqual=" + DEFAULT_TRANSACTION_DATE);

        // Get all the supplierTransactionsList where transactionDate is less than or equal to SMALLER_TRANSACTION_DATE
        defaultSupplierTransactionsShouldNotBeFound("transactionDate.lessThanOrEqual=" + SMALLER_TRANSACTION_DATE);
    }

    @Test
    @Transactional
    public void getAllSupplierTransactionsByTransactionDateIsLessThanSomething() throws Exception {
        // Initialize the database
        supplierTransactionsRepository.saveAndFlush(supplierTransactions);

        // Get all the supplierTransactionsList where transactionDate is less than DEFAULT_TRANSACTION_DATE
        defaultSupplierTransactionsShouldNotBeFound("transactionDate.lessThan=" + DEFAULT_TRANSACTION_DATE);

        // Get all the supplierTransactionsList where transactionDate is less than UPDATED_TRANSACTION_DATE
        defaultSupplierTransactionsShouldBeFound("transactionDate.lessThan=" + UPDATED_TRANSACTION_DATE);
    }

    @Test
    @Transactional
    public void getAllSupplierTransactionsByTransactionDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        supplierTransactionsRepository.saveAndFlush(supplierTransactions);

        // Get all the supplierTransactionsList where transactionDate is greater than DEFAULT_TRANSACTION_DATE
        defaultSupplierTransactionsShouldNotBeFound("transactionDate.greaterThan=" + DEFAULT_TRANSACTION_DATE);

        // Get all the supplierTransactionsList where transactionDate is greater than SMALLER_TRANSACTION_DATE
        defaultSupplierTransactionsShouldBeFound("transactionDate.greaterThan=" + SMALLER_TRANSACTION_DATE);
    }
    ...
    @Test
    @Transactional
    public void getAllSupplierTransactionsByFinalizationDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        supplierTransactionsRepository.saveAndFlush(supplierTransactions);

        // Get all the supplierTransactionsList where finalizationDate is greater than or equal to DEFAULT_FINALIZATION_DATE
        defaultSupplierTransactionsShouldBeFound("finalizationDate.greaterThanOrEqual=" + DEFAULT_FINALIZATION_DATE);

        // Get all the supplierTransactionsList where finalizationDate is greater than or equal to UPDATED_FINALIZATION_DATE
        defaultSupplierTransactionsShouldNotBeFound("finalizationDate.greaterThanOrEqual=" + UPDATED_FINALIZATION_DATE);
    }

    @Test
    @Transactional
    public void getAllSupplierTransactionsByFinalizationDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        supplierTransactionsRepository.saveAndFlush(supplierTransactions);

        // Get all the supplierTransactionsList where finalizationDate is less than or equal to DEFAULT_FINALIZATION_DATE
        defaultSupplierTransactionsShouldBeFound("finalizationDate.lessThanOrEqual=" + DEFAULT_FINALIZATION_DATE);

        // Get all the supplierTransactionsList where finalizationDate is less than or equal to SMALLER_FINALIZATION_DATE
        defaultSupplierTransactionsShouldNotBeFound("finalizationDate.lessThanOrEqual=" + SMALLER_FINALIZATION_DATE);
    }

    @Test
    @Transactional
    public void getAllSupplierTransactionsByFinalizationDateIsLessThanSomething() throws Exception {
        // Initialize the database
        supplierTransactionsRepository.saveAndFlush(supplierTransactions);

        // Get all the supplierTransactionsList where finalizationDate is less than DEFAULT_FINALIZATION_DATE
        defaultSupplierTransactionsShouldNotBeFound("finalizationDate.lessThan=" + DEFAULT_FINALIZATION_DATE);

        // Get all the supplierTransactionsList where finalizationDate is less than UPDATED_FINALIZATION_DATE
        defaultSupplierTransactionsShouldBeFound("finalizationDate.lessThan=" + UPDATED_FINALIZATION_DATE);
    }

    @Test
    @Transactional
    public void getAllSupplierTransactionsByFinalizationDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        supplierTransactionsRepository.saveAndFlush(supplierTransactions);

        // Get all the supplierTransactionsList where finalizationDate is greater than DEFAULT_FINALIZATION_DATE
        defaultSupplierTransactionsShouldNotBeFound("finalizationDate.greaterThan=" + DEFAULT_FINALIZATION_DATE);

        // Get all the supplierTransactionsList where finalizationDate is greater than SMALLER_FINALIZATION_DATE
        defaultSupplierTransactionsShouldBeFound("finalizationDate.greaterThan=" + SMALLER_FINALIZATION_DATE);
    }
    ...
    @Test
    @Transactional
    public void getAllSupplierTransactionsByLastEditedWhenIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        supplierTransactionsRepository.saveAndFlush(supplierTransactions);

        // Get all the supplierTransactionsList where lastEditedWhen is greater than or equal to DEFAULT_LAST_EDITED_WHEN
        defaultSupplierTransactionsShouldBeFound("lastEditedWhen.greaterThanOrEqual=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the supplierTransactionsList where lastEditedWhen is greater than or equal to UPDATED_LAST_EDITED_WHEN
        defaultSupplierTransactionsShouldNotBeFound("lastEditedWhen.greaterThanOrEqual=" + UPDATED_LAST_EDITED_WHEN);
    }

    @Test
    @Transactional
    public void getAllSupplierTransactionsByLastEditedWhenIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        supplierTransactionsRepository.saveAndFlush(supplierTransactions);

        // Get all the supplierTransactionsList where lastEditedWhen is less than or equal to DEFAULT_LAST_EDITED_WHEN
        defaultSupplierTransactionsShouldBeFound("lastEditedWhen.lessThanOrEqual=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the supplierTransactionsList where lastEditedWhen is less than or equal to SMALLER_LAST_EDITED_WHEN
        defaultSupplierTransactionsShouldNotBeFound("lastEditedWhen.lessThanOrEqual=" + SMALLER_LAST_EDITED_WHEN);
    }

    @Test
    @Transactional
    public void getAllSupplierTransactionsByLastEditedWhenIsLessThanSomething() throws Exception {
        // Initialize the database
        supplierTransactionsRepository.saveAndFlush(supplierTransactions);

        // Get all the supplierTransactionsList where lastEditedWhen is less than DEFAULT_LAST_EDITED_WHEN
        defaultSupplierTransactionsShouldNotBeFound("lastEditedWhen.lessThan=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the supplierTransactionsList where lastEditedWhen is less than UPDATED_LAST_EDITED_WHEN
        defaultSupplierTransactionsShouldBeFound("lastEditedWhen.lessThan=" + UPDATED_LAST_EDITED_WHEN);
    }

    @Test
    @Transactional
    public void getAllSupplierTransactionsByLastEditedWhenIsGreaterThanSomething() throws Exception {
        // Initialize the database
        supplierTransactionsRepository.saveAndFlush(supplierTransactions);

        // Get all the supplierTransactionsList where lastEditedWhen is greater than DEFAULT_LAST_EDITED_WHEN
        defaultSupplierTransactionsShouldNotBeFound("lastEditedWhen.greaterThan=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the supplierTransactionsList where lastEditedWhen is greater than SMALLER_LAST_EDITED_WHEN
        defaultSupplierTransactionsShouldBeFound("lastEditedWhen.greaterThan=" + SMALLER_LAST_EDITED_WHEN);
    }
    ...
    @Test
    @Transactional
    public void getAllSupplierTransactionsByPaymentMethodIsEqualToSomething() throws Exception {
        // Initialize the database
        supplierTransactionsRepository.saveAndFlush(supplierTransactions);
        PaymentMethods paymentMethod = PaymentMethodsResourceIT.createEntity(em);
        em.persist(paymentMethod);
        em.flush();
        supplierTransactions.setPaymentMethod(paymentMethod);
        supplierTransactionsRepository.saveAndFlush(supplierTransactions);
        Long paymentMethodId = paymentMethod.getId();

        // Get all the supplierTransactionsList where paymentMethod equals to paymentMethodId
        defaultSupplierTransactionsShouldBeFound("paymentMethodId.equals=" + paymentMethodId);

        // Get all the supplierTransactionsList where paymentMethod equals to paymentMethodId + 1
        defaultSupplierTransactionsShouldNotBeFound("paymentMethodId.equals=" + (paymentMethodId + 1));
    }
