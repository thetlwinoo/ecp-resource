...
import com.resource.server.service.dto.ShoppingCartsCriteria;
import com.resource.server.service.ShoppingCartsQueryService;
...
public class ShoppingCartsResourceIT {
    ...
    private static final Float SMALLER_TOTAL_CARGO_PRICE = 1F - 1F;
    ...
    @Test
    @Transactional
    public void getAllShoppingCartsByLastEditedWhenIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        shoppingCartsRepository.saveAndFlush(shoppingCarts);

        // Get all the shoppingCartsList where lastEditedWhen is greater than or equal to DEFAULT_LAST_EDITED_WHEN
        defaultShoppingCartsShouldBeFound("lastEditedWhen.greaterThanOrEqual=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the shoppingCartsList where lastEditedWhen is greater than or equal to UPDATED_LAST_EDITED_WHEN
        defaultShoppingCartsShouldNotBeFound("lastEditedWhen.greaterThanOrEqual=" + UPDATED_LAST_EDITED_WHEN);
    }

    @Test
    @Transactional
    public void getAllShoppingCartsByLastEditedWhenIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        shoppingCartsRepository.saveAndFlush(shoppingCarts);

        // Get all the shoppingCartsList where lastEditedWhen is less than or equal to DEFAULT_LAST_EDITED_WHEN
        defaultShoppingCartsShouldBeFound("lastEditedWhen.lessThanOrEqual=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the shoppingCartsList where lastEditedWhen is less than or equal to SMALLER_LAST_EDITED_WHEN
        defaultShoppingCartsShouldNotBeFound("lastEditedWhen.lessThanOrEqual=" + SMALLER_LAST_EDITED_WHEN);
    }

    @Test
    @Transactional
    public void getAllShoppingCartsByLastEditedWhenIsLessThanSomething() throws Exception {
        // Initialize the database
        shoppingCartsRepository.saveAndFlush(shoppingCarts);

        // Get all the shoppingCartsList where lastEditedWhen is less than DEFAULT_LAST_EDITED_WHEN
        defaultShoppingCartsShouldNotBeFound("lastEditedWhen.lessThan=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the shoppingCartsList where lastEditedWhen is less than UPDATED_LAST_EDITED_WHEN
        defaultShoppingCartsShouldBeFound("lastEditedWhen.lessThan=" + UPDATED_LAST_EDITED_WHEN);
    }

    @Test
    @Transactional
    public void getAllShoppingCartsByLastEditedWhenIsGreaterThanSomething() throws Exception {
        // Initialize the database
        shoppingCartsRepository.saveAndFlush(shoppingCarts);

        // Get all the shoppingCartsList where lastEditedWhen is greater than DEFAULT_LAST_EDITED_WHEN
        defaultShoppingCartsShouldNotBeFound("lastEditedWhen.greaterThan=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the shoppingCartsList where lastEditedWhen is greater than SMALLER_LAST_EDITED_WHEN
        defaultShoppingCartsShouldBeFound("lastEditedWhen.greaterThan=" + SMALLER_LAST_EDITED_WHEN);
    }
