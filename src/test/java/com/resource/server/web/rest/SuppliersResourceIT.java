...
public class SuppliersResourceIT {
    ...
    public void getAllSuppliersByValidFromIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the suppliersList where validFrom is greater than or equal to DEFAULT_VALID_FROM
        defaultSuppliersShouldBeFound("validFrom.greaterThanOrEqual=" + DEFAULT_VALID_FROM);

        // Get all the suppliersList where validFrom is greater than or equal to UPDATED_VALID_FROM
        defaultSuppliersShouldNotBeFound("validFrom.greaterThanOrEqual=" + UPDATED_VALID_FROM);
    }

    @Test
    @Transactional
    public void getAllSuppliersByValidFromIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        suppliersRepository.saveAndFlush(suppliers);

        // Get all the suppliersList where validFrom is less than or equal to DEFAULT_VALID_FROM
        defaultSuppliersShouldBeFound("validFrom.lessThanOrEqual=" + DEFAULT_VALID_FROM);

        // Get all the suppliersList where validFrom is less than or equal to SMALLER_VALID_FROM
        defaultSuppliersShouldNotBeFound("validFrom.lessThanOrEqual=" + SMALLER_VALID_FROM);
    }
    ...
    public void getAllSuppliersByValidFromIsLessThanSomething() throws Exception {
        ...
        // Get all the suppliersList where validFrom is less than DEFAULT_VALID_FROM
        defaultSuppliersShouldNotBeFound("validFrom.lessThan=" + DEFAULT_VALID_FROM);

        // Get all the suppliersList where validFrom is less than UPDATED_VALID_FROM
        defaultSuppliersShouldBeFound("validFrom.lessThan=" + UPDATED_VALID_FROM);
    }

    @Test
    @Transactional
    public void getAllSuppliersByValidFromIsGreaterThanSomething() throws Exception {
        // Initialize the database
        suppliersRepository.saveAndFlush(suppliers);

        // Get all the suppliersList where validFrom is greater than DEFAULT_VALID_FROM
        defaultSuppliersShouldNotBeFound("validFrom.greaterThan=" + DEFAULT_VALID_FROM);

        // Get all the suppliersList where validFrom is greater than SMALLER_VALID_FROM
        defaultSuppliersShouldBeFound("validFrom.greaterThan=" + SMALLER_VALID_FROM);
    }
    ...
    public void getAllSuppliersByValidToIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the suppliersList where validTo is greater than or equal to DEFAULT_VALID_TO
        defaultSuppliersShouldBeFound("validTo.greaterThanOrEqual=" + DEFAULT_VALID_TO);

        // Get all the suppliersList where validTo is greater than or equal to UPDATED_VALID_TO
        defaultSuppliersShouldNotBeFound("validTo.greaterThanOrEqual=" + UPDATED_VALID_TO);
    }

    @Test
    @Transactional
    public void getAllSuppliersByValidToIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        suppliersRepository.saveAndFlush(suppliers);

        // Get all the suppliersList where validTo is less than or equal to DEFAULT_VALID_TO
        defaultSuppliersShouldBeFound("validTo.lessThanOrEqual=" + DEFAULT_VALID_TO);

        // Get all the suppliersList where validTo is less than or equal to SMALLER_VALID_TO
        defaultSuppliersShouldNotBeFound("validTo.lessThanOrEqual=" + SMALLER_VALID_TO);
    }
    ...
    public void getAllSuppliersByValidToIsLessThanSomething() throws Exception {
        ...
        // Get all the suppliersList where validTo is less than DEFAULT_VALID_TO
        defaultSuppliersShouldNotBeFound("validTo.lessThan=" + DEFAULT_VALID_TO);

        // Get all the suppliersList where validTo is less than UPDATED_VALID_TO
        defaultSuppliersShouldBeFound("validTo.lessThan=" + UPDATED_VALID_TO);
    }

    @Test
    @Transactional
    public void getAllSuppliersByValidToIsGreaterThanSomething() throws Exception {
        // Initialize the database
        suppliersRepository.saveAndFlush(suppliers);

        // Get all the suppliersList where validTo is greater than DEFAULT_VALID_TO
        defaultSuppliersShouldNotBeFound("validTo.greaterThan=" + DEFAULT_VALID_TO);

        // Get all the suppliersList where validTo is greater than SMALLER_VALID_TO
        defaultSuppliersShouldBeFound("validTo.greaterThan=" + SMALLER_VALID_TO);
    }
    ...
    public void getAllSuppliersByPrimaryContactPersonIsEqualToSomething() throws Exception {
        // Initialize the database
        suppliersRepository.saveAndFlush(suppliers);
        People primaryContactPerson = PeopleResourceIT.createEntity(em);
    ...
    public void getAllSuppliersByAlternateContactPersonIsEqualToSomething() throws Exception {
        // Initialize the database
        suppliersRepository.saveAndFlush(suppliers);
        People alternateContactPerson = PeopleResourceIT.createEntity(em);
