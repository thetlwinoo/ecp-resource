...
import com.resource.server.service.dto.ShoppingCartItemsCriteria;
import com.resource.server.service.ShoppingCartItemsQueryService;
...
public class ShoppingCartItemsResourceIT {
    ...
    @Test
    @Transactional
    public void getAllShoppingCartItemsByLastEditedWhenIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        shoppingCartItemsRepository.saveAndFlush(shoppingCartItems);

        // Get all the shoppingCartItemsList where lastEditedWhen is greater than or equal to DEFAULT_LAST_EDITED_WHEN
        defaultShoppingCartItemsShouldBeFound("lastEditedWhen.greaterThanOrEqual=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the shoppingCartItemsList where lastEditedWhen is greater than or equal to UPDATED_LAST_EDITED_WHEN
        defaultShoppingCartItemsShouldNotBeFound("lastEditedWhen.greaterThanOrEqual=" + UPDATED_LAST_EDITED_WHEN);
    }

    @Test
    @Transactional
    public void getAllShoppingCartItemsByLastEditedWhenIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        shoppingCartItemsRepository.saveAndFlush(shoppingCartItems);

        // Get all the shoppingCartItemsList where lastEditedWhen is less than or equal to DEFAULT_LAST_EDITED_WHEN
        defaultShoppingCartItemsShouldBeFound("lastEditedWhen.lessThanOrEqual=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the shoppingCartItemsList where lastEditedWhen is less than or equal to SMALLER_LAST_EDITED_WHEN
        defaultShoppingCartItemsShouldNotBeFound("lastEditedWhen.lessThanOrEqual=" + SMALLER_LAST_EDITED_WHEN);
    }

    @Test
    @Transactional
    public void getAllShoppingCartItemsByLastEditedWhenIsLessThanSomething() throws Exception {
        // Initialize the database
        shoppingCartItemsRepository.saveAndFlush(shoppingCartItems);

        // Get all the shoppingCartItemsList where lastEditedWhen is less than DEFAULT_LAST_EDITED_WHEN
        defaultShoppingCartItemsShouldNotBeFound("lastEditedWhen.lessThan=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the shoppingCartItemsList where lastEditedWhen is less than UPDATED_LAST_EDITED_WHEN
        defaultShoppingCartItemsShouldBeFound("lastEditedWhen.lessThan=" + UPDATED_LAST_EDITED_WHEN);
    }

    @Test
    @Transactional
    public void getAllShoppingCartItemsByLastEditedWhenIsGreaterThanSomething() throws Exception {
        // Initialize the database
        shoppingCartItemsRepository.saveAndFlush(shoppingCartItems);

        // Get all the shoppingCartItemsList where lastEditedWhen is greater than DEFAULT_LAST_EDITED_WHEN
        defaultShoppingCartItemsShouldNotBeFound("lastEditedWhen.greaterThan=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the shoppingCartItemsList where lastEditedWhen is greater than SMALLER_LAST_EDITED_WHEN
        defaultShoppingCartItemsShouldBeFound("lastEditedWhen.greaterThan=" + SMALLER_LAST_EDITED_WHEN);
    }
