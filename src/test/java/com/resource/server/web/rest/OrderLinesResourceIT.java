...
import com.resource.server.service.dto.OrderLinesCriteria;
import com.resource.server.service.OrderLinesQueryService;
...
public class OrderLinesResourceIT {
    ...
    private static final Float SMALLER_UNIT_PRICE_DISCOUNT = 1F - 1F;
    ...
    @Test
    @Transactional
    public void getAllOrderLinesByPickingCompletedWhenIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        orderLinesRepository.saveAndFlush(orderLines);

        // Get all the orderLinesList where pickingCompletedWhen is greater than or equal to DEFAULT_PICKING_COMPLETED_WHEN
        defaultOrderLinesShouldBeFound("pickingCompletedWhen.greaterThanOrEqual=" + DEFAULT_PICKING_COMPLETED_WHEN);

        // Get all the orderLinesList where pickingCompletedWhen is greater than or equal to UPDATED_PICKING_COMPLETED_WHEN
        defaultOrderLinesShouldNotBeFound("pickingCompletedWhen.greaterThanOrEqual=" + UPDATED_PICKING_COMPLETED_WHEN);
    }

    @Test
    @Transactional
    public void getAllOrderLinesByPickingCompletedWhenIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        orderLinesRepository.saveAndFlush(orderLines);

        // Get all the orderLinesList where pickingCompletedWhen is less than or equal to DEFAULT_PICKING_COMPLETED_WHEN
        defaultOrderLinesShouldBeFound("pickingCompletedWhen.lessThanOrEqual=" + DEFAULT_PICKING_COMPLETED_WHEN);

        // Get all the orderLinesList where pickingCompletedWhen is less than or equal to SMALLER_PICKING_COMPLETED_WHEN
        defaultOrderLinesShouldNotBeFound("pickingCompletedWhen.lessThanOrEqual=" + SMALLER_PICKING_COMPLETED_WHEN);
    }

    @Test
    @Transactional
    public void getAllOrderLinesByPickingCompletedWhenIsLessThanSomething() throws Exception {
        // Initialize the database
        orderLinesRepository.saveAndFlush(orderLines);

        // Get all the orderLinesList where pickingCompletedWhen is less than DEFAULT_PICKING_COMPLETED_WHEN
        defaultOrderLinesShouldNotBeFound("pickingCompletedWhen.lessThan=" + DEFAULT_PICKING_COMPLETED_WHEN);

        // Get all the orderLinesList where pickingCompletedWhen is less than UPDATED_PICKING_COMPLETED_WHEN
        defaultOrderLinesShouldBeFound("pickingCompletedWhen.lessThan=" + UPDATED_PICKING_COMPLETED_WHEN);
    }

    @Test
    @Transactional
    public void getAllOrderLinesByPickingCompletedWhenIsGreaterThanSomething() throws Exception {
        // Initialize the database
        orderLinesRepository.saveAndFlush(orderLines);

        // Get all the orderLinesList where pickingCompletedWhen is greater than DEFAULT_PICKING_COMPLETED_WHEN
        defaultOrderLinesShouldNotBeFound("pickingCompletedWhen.greaterThan=" + DEFAULT_PICKING_COMPLETED_WHEN);

        // Get all the orderLinesList where pickingCompletedWhen is greater than SMALLER_PICKING_COMPLETED_WHEN
        defaultOrderLinesShouldBeFound("pickingCompletedWhen.greaterThan=" + SMALLER_PICKING_COMPLETED_WHEN);
    }
    ...
    @Test
    @Transactional
    public void getAllOrderLinesByLastEditedWhenIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        orderLinesRepository.saveAndFlush(orderLines);

        // Get all the orderLinesList where lastEditedWhen is greater than or equal to DEFAULT_LAST_EDITED_WHEN
        defaultOrderLinesShouldBeFound("lastEditedWhen.greaterThanOrEqual=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the orderLinesList where lastEditedWhen is greater than or equal to UPDATED_LAST_EDITED_WHEN
        defaultOrderLinesShouldNotBeFound("lastEditedWhen.greaterThanOrEqual=" + UPDATED_LAST_EDITED_WHEN);
    }

    @Test
    @Transactional
    public void getAllOrderLinesByLastEditedWhenIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        orderLinesRepository.saveAndFlush(orderLines);

        // Get all the orderLinesList where lastEditedWhen is less than or equal to DEFAULT_LAST_EDITED_WHEN
        defaultOrderLinesShouldBeFound("lastEditedWhen.lessThanOrEqual=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the orderLinesList where lastEditedWhen is less than or equal to SMALLER_LAST_EDITED_WHEN
        defaultOrderLinesShouldNotBeFound("lastEditedWhen.lessThanOrEqual=" + SMALLER_LAST_EDITED_WHEN);
    }

    @Test
    @Transactional
    public void getAllOrderLinesByLastEditedWhenIsLessThanSomething() throws Exception {
        // Initialize the database
        orderLinesRepository.saveAndFlush(orderLines);

        // Get all the orderLinesList where lastEditedWhen is less than DEFAULT_LAST_EDITED_WHEN
        defaultOrderLinesShouldNotBeFound("lastEditedWhen.lessThan=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the orderLinesList where lastEditedWhen is less than UPDATED_LAST_EDITED_WHEN
        defaultOrderLinesShouldBeFound("lastEditedWhen.lessThan=" + UPDATED_LAST_EDITED_WHEN);
    }

    @Test
    @Transactional
    public void getAllOrderLinesByLastEditedWhenIsGreaterThanSomething() throws Exception {
        // Initialize the database
        orderLinesRepository.saveAndFlush(orderLines);

        // Get all the orderLinesList where lastEditedWhen is greater than DEFAULT_LAST_EDITED_WHEN
        defaultOrderLinesShouldNotBeFound("lastEditedWhen.greaterThan=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the orderLinesList where lastEditedWhen is greater than SMALLER_LAST_EDITED_WHEN
        defaultOrderLinesShouldBeFound("lastEditedWhen.greaterThan=" + SMALLER_LAST_EDITED_WHEN);
    }
