...
import com.resource.server.service.dto.UploadTransactionsCriteria;
import com.resource.server.service.UploadTransactionsQueryService;
...
public class UploadTransactionsResourceIT {
    ...
    @Test
    @Transactional
    public void getAllUploadTransactionsByLastEditedWhenIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        uploadTransactionsRepository.saveAndFlush(uploadTransactions);

        // Get all the uploadTransactionsList where lastEditedWhen is greater than or equal to DEFAULT_LAST_EDITED_WHEN
        defaultUploadTransactionsShouldBeFound("lastEditedWhen.greaterThanOrEqual=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the uploadTransactionsList where lastEditedWhen is greater than or equal to UPDATED_LAST_EDITED_WHEN
        defaultUploadTransactionsShouldNotBeFound("lastEditedWhen.greaterThanOrEqual=" + UPDATED_LAST_EDITED_WHEN);
    }

    @Test
    @Transactional
    public void getAllUploadTransactionsByLastEditedWhenIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        uploadTransactionsRepository.saveAndFlush(uploadTransactions);

        // Get all the uploadTransactionsList where lastEditedWhen is less than or equal to DEFAULT_LAST_EDITED_WHEN
        defaultUploadTransactionsShouldBeFound("lastEditedWhen.lessThanOrEqual=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the uploadTransactionsList where lastEditedWhen is less than or equal to SMALLER_LAST_EDITED_WHEN
        defaultUploadTransactionsShouldNotBeFound("lastEditedWhen.lessThanOrEqual=" + SMALLER_LAST_EDITED_WHEN);
    }

    @Test
    @Transactional
    public void getAllUploadTransactionsByLastEditedWhenIsLessThanSomething() throws Exception {
        // Initialize the database
        uploadTransactionsRepository.saveAndFlush(uploadTransactions);

        // Get all the uploadTransactionsList where lastEditedWhen is less than DEFAULT_LAST_EDITED_WHEN
        defaultUploadTransactionsShouldNotBeFound("lastEditedWhen.lessThan=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the uploadTransactionsList where lastEditedWhen is less than UPDATED_LAST_EDITED_WHEN
        defaultUploadTransactionsShouldBeFound("lastEditedWhen.lessThan=" + UPDATED_LAST_EDITED_WHEN);
    }

    @Test
    @Transactional
    public void getAllUploadTransactionsByLastEditedWhenIsGreaterThanSomething() throws Exception {
        // Initialize the database
        uploadTransactionsRepository.saveAndFlush(uploadTransactions);

        // Get all the uploadTransactionsList where lastEditedWhen is greater than DEFAULT_LAST_EDITED_WHEN
        defaultUploadTransactionsShouldNotBeFound("lastEditedWhen.greaterThan=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the uploadTransactionsList where lastEditedWhen is greater than SMALLER_LAST_EDITED_WHEN
        defaultUploadTransactionsShouldBeFound("lastEditedWhen.greaterThan=" + SMALLER_LAST_EDITED_WHEN);
    }
