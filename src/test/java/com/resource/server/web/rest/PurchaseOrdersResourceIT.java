...
import com.resource.server.service.dto.PurchaseOrdersCriteria;
import com.resource.server.service.PurchaseOrdersQueryService;
...
public class PurchaseOrdersResourceIT {
    ...
    @Test
    @Transactional
    public void getAllPurchaseOrdersByOrderDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        purchaseOrdersRepository.saveAndFlush(purchaseOrders);

        // Get all the purchaseOrdersList where orderDate is greater than or equal to DEFAULT_ORDER_DATE
        defaultPurchaseOrdersShouldBeFound("orderDate.greaterThanOrEqual=" + DEFAULT_ORDER_DATE);

        // Get all the purchaseOrdersList where orderDate is greater than or equal to UPDATED_ORDER_DATE
        defaultPurchaseOrdersShouldNotBeFound("orderDate.greaterThanOrEqual=" + UPDATED_ORDER_DATE);
    }

    @Test
    @Transactional
    public void getAllPurchaseOrdersByOrderDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        purchaseOrdersRepository.saveAndFlush(purchaseOrders);

        // Get all the purchaseOrdersList where orderDate is less than or equal to DEFAULT_ORDER_DATE
        defaultPurchaseOrdersShouldBeFound("orderDate.lessThanOrEqual=" + DEFAULT_ORDER_DATE);

        // Get all the purchaseOrdersList where orderDate is less than or equal to SMALLER_ORDER_DATE
        defaultPurchaseOrdersShouldNotBeFound("orderDate.lessThanOrEqual=" + SMALLER_ORDER_DATE);
    }

    @Test
    @Transactional
    public void getAllPurchaseOrdersByOrderDateIsLessThanSomething() throws Exception {
        // Initialize the database
        purchaseOrdersRepository.saveAndFlush(purchaseOrders);

        // Get all the purchaseOrdersList where orderDate is less than DEFAULT_ORDER_DATE
        defaultPurchaseOrdersShouldNotBeFound("orderDate.lessThan=" + DEFAULT_ORDER_DATE);

        // Get all the purchaseOrdersList where orderDate is less than UPDATED_ORDER_DATE
        defaultPurchaseOrdersShouldBeFound("orderDate.lessThan=" + UPDATED_ORDER_DATE);
    }

    @Test
    @Transactional
    public void getAllPurchaseOrdersByOrderDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        purchaseOrdersRepository.saveAndFlush(purchaseOrders);

        // Get all the purchaseOrdersList where orderDate is greater than DEFAULT_ORDER_DATE
        defaultPurchaseOrdersShouldNotBeFound("orderDate.greaterThan=" + DEFAULT_ORDER_DATE);

        // Get all the purchaseOrdersList where orderDate is greater than SMALLER_ORDER_DATE
        defaultPurchaseOrdersShouldBeFound("orderDate.greaterThan=" + SMALLER_ORDER_DATE);
    }
    ...
    @Test
    @Transactional
    public void getAllPurchaseOrdersByLastEditedWhenIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        purchaseOrdersRepository.saveAndFlush(purchaseOrders);

        // Get all the purchaseOrdersList where lastEditedWhen is greater than or equal to DEFAULT_LAST_EDITED_WHEN
        defaultPurchaseOrdersShouldBeFound("lastEditedWhen.greaterThanOrEqual=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the purchaseOrdersList where lastEditedWhen is greater than or equal to UPDATED_LAST_EDITED_WHEN
        defaultPurchaseOrdersShouldNotBeFound("lastEditedWhen.greaterThanOrEqual=" + UPDATED_LAST_EDITED_WHEN);
    }

    @Test
    @Transactional
    public void getAllPurchaseOrdersByLastEditedWhenIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        purchaseOrdersRepository.saveAndFlush(purchaseOrders);

        // Get all the purchaseOrdersList where lastEditedWhen is less than or equal to DEFAULT_LAST_EDITED_WHEN
        defaultPurchaseOrdersShouldBeFound("lastEditedWhen.lessThanOrEqual=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the purchaseOrdersList where lastEditedWhen is less than or equal to SMALLER_LAST_EDITED_WHEN
        defaultPurchaseOrdersShouldNotBeFound("lastEditedWhen.lessThanOrEqual=" + SMALLER_LAST_EDITED_WHEN);
    }

    @Test
    @Transactional
    public void getAllPurchaseOrdersByLastEditedWhenIsLessThanSomething() throws Exception {
        // Initialize the database
        purchaseOrdersRepository.saveAndFlush(purchaseOrders);

        // Get all the purchaseOrdersList where lastEditedWhen is less than DEFAULT_LAST_EDITED_WHEN
        defaultPurchaseOrdersShouldNotBeFound("lastEditedWhen.lessThan=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the purchaseOrdersList where lastEditedWhen is less than UPDATED_LAST_EDITED_WHEN
        defaultPurchaseOrdersShouldBeFound("lastEditedWhen.lessThan=" + UPDATED_LAST_EDITED_WHEN);
    }

    @Test
    @Transactional
    public void getAllPurchaseOrdersByLastEditedWhenIsGreaterThanSomething() throws Exception {
        // Initialize the database
        purchaseOrdersRepository.saveAndFlush(purchaseOrders);

        // Get all the purchaseOrdersList where lastEditedWhen is greater than DEFAULT_LAST_EDITED_WHEN
        defaultPurchaseOrdersShouldNotBeFound("lastEditedWhen.greaterThan=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the purchaseOrdersList where lastEditedWhen is greater than SMALLER_LAST_EDITED_WHEN
        defaultPurchaseOrdersShouldBeFound("lastEditedWhen.greaterThan=" + SMALLER_LAST_EDITED_WHEN);
    }
