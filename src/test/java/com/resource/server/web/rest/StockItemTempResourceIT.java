...
import com.resource.server.service.dto.StockItemTempCriteria;
import com.resource.server.service.StockItemTempQueryService;
...
public class StockItemTempResourceIT {
    ...
    private static final Float SMALLER_REMOMMENDED_RETAIL_PRICE = 1F - 1F;
    ...
    private static final Float SMALLER_ITEM_WEIGHT = 1F - 1F;
    ...
    private static final Float SMALLER_ITEM_PACKAGE_WEIGHT = 1F - 1F;
    ...
    private static final LocalDate SMALLER_SELL_START_DATE = LocalDate.ofEpochDay(-1L);
    ...
    private static final LocalDate SMALLER_SELL_END_DATE = LocalDate.ofEpochDay(-1L);
    ...
    @Test
    @Transactional
    public void getAllStockItemTempsBySellStartDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        stockItemTempRepository.saveAndFlush(stockItemTemp);

        // Get all the stockItemTempList where sellStartDate is greater than or equal to DEFAULT_SELL_START_DATE
        defaultStockItemTempShouldBeFound("sellStartDate.greaterThanOrEqual=" + DEFAULT_SELL_START_DATE);

        // Get all the stockItemTempList where sellStartDate is greater than or equal to UPDATED_SELL_START_DATE
        defaultStockItemTempShouldNotBeFound("sellStartDate.greaterThanOrEqual=" + UPDATED_SELL_START_DATE);
    }

    @Test
    @Transactional
    public void getAllStockItemTempsBySellStartDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        stockItemTempRepository.saveAndFlush(stockItemTemp);

        // Get all the stockItemTempList where sellStartDate is less than or equal to DEFAULT_SELL_START_DATE
        defaultStockItemTempShouldBeFound("sellStartDate.lessThanOrEqual=" + DEFAULT_SELL_START_DATE);

        // Get all the stockItemTempList where sellStartDate is less than or equal to SMALLER_SELL_START_DATE
        defaultStockItemTempShouldNotBeFound("sellStartDate.lessThanOrEqual=" + SMALLER_SELL_START_DATE);
    }

    @Test
    @Transactional
    public void getAllStockItemTempsBySellStartDateIsLessThanSomething() throws Exception {
        // Initialize the database
        stockItemTempRepository.saveAndFlush(stockItemTemp);

        // Get all the stockItemTempList where sellStartDate is less than DEFAULT_SELL_START_DATE
        defaultStockItemTempShouldNotBeFound("sellStartDate.lessThan=" + DEFAULT_SELL_START_DATE);

        // Get all the stockItemTempList where sellStartDate is less than UPDATED_SELL_START_DATE
        defaultStockItemTempShouldBeFound("sellStartDate.lessThan=" + UPDATED_SELL_START_DATE);
    }

    @Test
    @Transactional
    public void getAllStockItemTempsBySellStartDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        stockItemTempRepository.saveAndFlush(stockItemTemp);

        // Get all the stockItemTempList where sellStartDate is greater than DEFAULT_SELL_START_DATE
        defaultStockItemTempShouldNotBeFound("sellStartDate.greaterThan=" + DEFAULT_SELL_START_DATE);

        // Get all the stockItemTempList where sellStartDate is greater than SMALLER_SELL_START_DATE
        defaultStockItemTempShouldBeFound("sellStartDate.greaterThan=" + SMALLER_SELL_START_DATE);
    }
    ...
    @Test
    @Transactional
    public void getAllStockItemTempsBySellEndDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        stockItemTempRepository.saveAndFlush(stockItemTemp);

        // Get all the stockItemTempList where sellEndDate is greater than or equal to DEFAULT_SELL_END_DATE
        defaultStockItemTempShouldBeFound("sellEndDate.greaterThanOrEqual=" + DEFAULT_SELL_END_DATE);

        // Get all the stockItemTempList where sellEndDate is greater than or equal to UPDATED_SELL_END_DATE
        defaultStockItemTempShouldNotBeFound("sellEndDate.greaterThanOrEqual=" + UPDATED_SELL_END_DATE);
    }

    @Test
    @Transactional
    public void getAllStockItemTempsBySellEndDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        stockItemTempRepository.saveAndFlush(stockItemTemp);

        // Get all the stockItemTempList where sellEndDate is less than or equal to DEFAULT_SELL_END_DATE
        defaultStockItemTempShouldBeFound("sellEndDate.lessThanOrEqual=" + DEFAULT_SELL_END_DATE);

        // Get all the stockItemTempList where sellEndDate is less than or equal to SMALLER_SELL_END_DATE
        defaultStockItemTempShouldNotBeFound("sellEndDate.lessThanOrEqual=" + SMALLER_SELL_END_DATE);
    }

    @Test
    @Transactional
    public void getAllStockItemTempsBySellEndDateIsLessThanSomething() throws Exception {
        // Initialize the database
        stockItemTempRepository.saveAndFlush(stockItemTemp);

        // Get all the stockItemTempList where sellEndDate is less than DEFAULT_SELL_END_DATE
        defaultStockItemTempShouldNotBeFound("sellEndDate.lessThan=" + DEFAULT_SELL_END_DATE);

        // Get all the stockItemTempList where sellEndDate is less than UPDATED_SELL_END_DATE
        defaultStockItemTempShouldBeFound("sellEndDate.lessThan=" + UPDATED_SELL_END_DATE);
    }

    @Test
    @Transactional
    public void getAllStockItemTempsBySellEndDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        stockItemTempRepository.saveAndFlush(stockItemTemp);

        // Get all the stockItemTempList where sellEndDate is greater than DEFAULT_SELL_END_DATE
        defaultStockItemTempShouldNotBeFound("sellEndDate.greaterThan=" + DEFAULT_SELL_END_DATE);

        // Get all the stockItemTempList where sellEndDate is greater than SMALLER_SELL_END_DATE
        defaultStockItemTempShouldBeFound("sellEndDate.greaterThan=" + SMALLER_SELL_END_DATE);
    }
    ...
    @Test
    @Transactional
    public void getAllStockItemTempsByLastEditedWhenIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        stockItemTempRepository.saveAndFlush(stockItemTemp);

        // Get all the stockItemTempList where lastEditedWhen is greater than or equal to DEFAULT_LAST_EDITED_WHEN
        defaultStockItemTempShouldBeFound("lastEditedWhen.greaterThanOrEqual=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the stockItemTempList where lastEditedWhen is greater than or equal to UPDATED_LAST_EDITED_WHEN
        defaultStockItemTempShouldNotBeFound("lastEditedWhen.greaterThanOrEqual=" + UPDATED_LAST_EDITED_WHEN);
    }

    @Test
    @Transactional
    public void getAllStockItemTempsByLastEditedWhenIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        stockItemTempRepository.saveAndFlush(stockItemTemp);

        // Get all the stockItemTempList where lastEditedWhen is less than or equal to DEFAULT_LAST_EDITED_WHEN
        defaultStockItemTempShouldBeFound("lastEditedWhen.lessThanOrEqual=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the stockItemTempList where lastEditedWhen is less than or equal to SMALLER_LAST_EDITED_WHEN
        defaultStockItemTempShouldNotBeFound("lastEditedWhen.lessThanOrEqual=" + SMALLER_LAST_EDITED_WHEN);
    }

    @Test
    @Transactional
    public void getAllStockItemTempsByLastEditedWhenIsLessThanSomething() throws Exception {
        // Initialize the database
        stockItemTempRepository.saveAndFlush(stockItemTemp);

        // Get all the stockItemTempList where lastEditedWhen is less than DEFAULT_LAST_EDITED_WHEN
        defaultStockItemTempShouldNotBeFound("lastEditedWhen.lessThan=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the stockItemTempList where lastEditedWhen is less than UPDATED_LAST_EDITED_WHEN
        defaultStockItemTempShouldBeFound("lastEditedWhen.lessThan=" + UPDATED_LAST_EDITED_WHEN);
    }

    @Test
    @Transactional
    public void getAllStockItemTempsByLastEditedWhenIsGreaterThanSomething() throws Exception {
        // Initialize the database
        stockItemTempRepository.saveAndFlush(stockItemTemp);

        // Get all the stockItemTempList where lastEditedWhen is greater than DEFAULT_LAST_EDITED_WHEN
        defaultStockItemTempShouldNotBeFound("lastEditedWhen.greaterThan=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the stockItemTempList where lastEditedWhen is greater than SMALLER_LAST_EDITED_WHEN
        defaultStockItemTempShouldBeFound("lastEditedWhen.greaterThan=" + SMALLER_LAST_EDITED_WHEN);
    }
