...
import com.resource.server.service.dto.InvoiceLinesCriteria;
import com.resource.server.service.InvoiceLinesQueryService;
...
public class InvoiceLinesResourceIT {
    ...
    @Test
    @Transactional
    public void getAllInvoiceLinesByLastEditedWhenIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        invoiceLinesRepository.saveAndFlush(invoiceLines);

        // Get all the invoiceLinesList where lastEditedWhen is greater than or equal to DEFAULT_LAST_EDITED_WHEN
        defaultInvoiceLinesShouldBeFound("lastEditedWhen.greaterThanOrEqual=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the invoiceLinesList where lastEditedWhen is greater than or equal to UPDATED_LAST_EDITED_WHEN
        defaultInvoiceLinesShouldNotBeFound("lastEditedWhen.greaterThanOrEqual=" + UPDATED_LAST_EDITED_WHEN);
    }

    @Test
    @Transactional
    public void getAllInvoiceLinesByLastEditedWhenIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        invoiceLinesRepository.saveAndFlush(invoiceLines);

        // Get all the invoiceLinesList where lastEditedWhen is less than or equal to DEFAULT_LAST_EDITED_WHEN
        defaultInvoiceLinesShouldBeFound("lastEditedWhen.lessThanOrEqual=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the invoiceLinesList where lastEditedWhen is less than or equal to SMALLER_LAST_EDITED_WHEN
        defaultInvoiceLinesShouldNotBeFound("lastEditedWhen.lessThanOrEqual=" + SMALLER_LAST_EDITED_WHEN);
    }

    @Test
    @Transactional
    public void getAllInvoiceLinesByLastEditedWhenIsLessThanSomething() throws Exception {
        // Initialize the database
        invoiceLinesRepository.saveAndFlush(invoiceLines);

        // Get all the invoiceLinesList where lastEditedWhen is less than DEFAULT_LAST_EDITED_WHEN
        defaultInvoiceLinesShouldNotBeFound("lastEditedWhen.lessThan=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the invoiceLinesList where lastEditedWhen is less than UPDATED_LAST_EDITED_WHEN
        defaultInvoiceLinesShouldBeFound("lastEditedWhen.lessThan=" + UPDATED_LAST_EDITED_WHEN);
    }

    @Test
    @Transactional
    public void getAllInvoiceLinesByLastEditedWhenIsGreaterThanSomething() throws Exception {
        // Initialize the database
        invoiceLinesRepository.saveAndFlush(invoiceLines);

        // Get all the invoiceLinesList where lastEditedWhen is greater than DEFAULT_LAST_EDITED_WHEN
        defaultInvoiceLinesShouldNotBeFound("lastEditedWhen.greaterThan=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the invoiceLinesList where lastEditedWhen is greater than SMALLER_LAST_EDITED_WHEN
        defaultInvoiceLinesShouldBeFound("lastEditedWhen.greaterThan=" + SMALLER_LAST_EDITED_WHEN);
    }
