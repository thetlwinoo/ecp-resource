...
import com.resource.server.service.dto.StateProvincesCriteria;
import com.resource.server.service.StateProvincesQueryService;
...
public class StateProvincesResourceIT {
    ...
    @Test
    @Transactional
    public void getAllStateProvincesByValidFromIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        stateProvincesRepository.saveAndFlush(stateProvinces);

        // Get all the stateProvincesList where validFrom is greater than or equal to DEFAULT_VALID_FROM
        defaultStateProvincesShouldBeFound("validFrom.greaterThanOrEqual=" + DEFAULT_VALID_FROM);

        // Get all the stateProvincesList where validFrom is greater than or equal to UPDATED_VALID_FROM
        defaultStateProvincesShouldNotBeFound("validFrom.greaterThanOrEqual=" + UPDATED_VALID_FROM);
    }

    @Test
    @Transactional
    public void getAllStateProvincesByValidFromIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        stateProvincesRepository.saveAndFlush(stateProvinces);

        // Get all the stateProvincesList where validFrom is less than or equal to DEFAULT_VALID_FROM
        defaultStateProvincesShouldBeFound("validFrom.lessThanOrEqual=" + DEFAULT_VALID_FROM);

        // Get all the stateProvincesList where validFrom is less than or equal to SMALLER_VALID_FROM
        defaultStateProvincesShouldNotBeFound("validFrom.lessThanOrEqual=" + SMALLER_VALID_FROM);
    }

    @Test
    @Transactional
    public void getAllStateProvincesByValidFromIsLessThanSomething() throws Exception {
        // Initialize the database
        stateProvincesRepository.saveAndFlush(stateProvinces);

        // Get all the stateProvincesList where validFrom is less than DEFAULT_VALID_FROM
        defaultStateProvincesShouldNotBeFound("validFrom.lessThan=" + DEFAULT_VALID_FROM);

        // Get all the stateProvincesList where validFrom is less than UPDATED_VALID_FROM
        defaultStateProvincesShouldBeFound("validFrom.lessThan=" + UPDATED_VALID_FROM);
    }

    @Test
    @Transactional
    public void getAllStateProvincesByValidFromIsGreaterThanSomething() throws Exception {
        // Initialize the database
        stateProvincesRepository.saveAndFlush(stateProvinces);

        // Get all the stateProvincesList where validFrom is greater than DEFAULT_VALID_FROM
        defaultStateProvincesShouldNotBeFound("validFrom.greaterThan=" + DEFAULT_VALID_FROM);

        // Get all the stateProvincesList where validFrom is greater than SMALLER_VALID_FROM
        defaultStateProvincesShouldBeFound("validFrom.greaterThan=" + SMALLER_VALID_FROM);
    }
    ...
    @Test
    @Transactional
    public void getAllStateProvincesByValidToIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        stateProvincesRepository.saveAndFlush(stateProvinces);

        // Get all the stateProvincesList where validTo is greater than or equal to DEFAULT_VALID_TO
        defaultStateProvincesShouldBeFound("validTo.greaterThanOrEqual=" + DEFAULT_VALID_TO);

        // Get all the stateProvincesList where validTo is greater than or equal to UPDATED_VALID_TO
        defaultStateProvincesShouldNotBeFound("validTo.greaterThanOrEqual=" + UPDATED_VALID_TO);
    }

    @Test
    @Transactional
    public void getAllStateProvincesByValidToIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        stateProvincesRepository.saveAndFlush(stateProvinces);

        // Get all the stateProvincesList where validTo is less than or equal to DEFAULT_VALID_TO
        defaultStateProvincesShouldBeFound("validTo.lessThanOrEqual=" + DEFAULT_VALID_TO);

        // Get all the stateProvincesList where validTo is less than or equal to SMALLER_VALID_TO
        defaultStateProvincesShouldNotBeFound("validTo.lessThanOrEqual=" + SMALLER_VALID_TO);
    }

    @Test
    @Transactional
    public void getAllStateProvincesByValidToIsLessThanSomething() throws Exception {
        // Initialize the database
        stateProvincesRepository.saveAndFlush(stateProvinces);

        // Get all the stateProvincesList where validTo is less than DEFAULT_VALID_TO
        defaultStateProvincesShouldNotBeFound("validTo.lessThan=" + DEFAULT_VALID_TO);

        // Get all the stateProvincesList where validTo is less than UPDATED_VALID_TO
        defaultStateProvincesShouldBeFound("validTo.lessThan=" + UPDATED_VALID_TO);
    }

    @Test
    @Transactional
    public void getAllStateProvincesByValidToIsGreaterThanSomething() throws Exception {
        // Initialize the database
        stateProvincesRepository.saveAndFlush(stateProvinces);

        // Get all the stateProvincesList where validTo is greater than DEFAULT_VALID_TO
        defaultStateProvincesShouldNotBeFound("validTo.greaterThan=" + DEFAULT_VALID_TO);

        // Get all the stateProvincesList where validTo is greater than SMALLER_VALID_TO
        defaultStateProvincesShouldBeFound("validTo.greaterThan=" + SMALLER_VALID_TO);
    }
