...
public class ProductCategoryResourceIT {
    ...
    @Test
    @Transactional
    public void getAllProductCategoriesByLabelIsNotEqualToSomething() throws Exception {
        // Initialize the database
        productCategoryRepository.saveAndFlush(productCategory);

        // Get all the productCategoryList where label not equals to DEFAULT_LABEL
        defaultProductCategoryShouldNotBeFound("label.notEquals=" + DEFAULT_LABEL);

        // Get all the productCategoryList where label not equals to UPDATED_LABEL
        defaultProductCategoryShouldBeFound("label.notEquals=" + UPDATED_LABEL);
    }
    ...
    public void getAllProductCategoriesByLabelIsNullOrNotNull() throws Exception {
        ...
        defaultProductCategoryShouldNotBeFound("label.specified=false");
                ...
                @Test
    @Transactional
    public void getAllProductCategoriesByLabelContainsSomething() throws Exception {
        // Initialize the database
        productCategoryRepository.saveAndFlush(productCategory);

        // Get all the productCategoryList where label contains DEFAULT_LABEL
        defaultProductCategoryShouldBeFound("label.contains=" + DEFAULT_LABEL);

        // Get all the productCategoryList where label contains UPDATED_LABEL
        defaultProductCategoryShouldNotBeFound("label.contains=" + UPDATED_LABEL);
    }

    @Test
    @Transactional
    public void getAllProductCategoriesByLabelNotContainsSomething() throws Exception {
        // Initialize the database
        productCategoryRepository.saveAndFlush(productCategory);

        // Get all the productCategoryList where label does not contain DEFAULT_LABEL
        defaultProductCategoryShouldNotBeFound("label.doesNotContain=" + DEFAULT_LABEL);

        // Get all the productCategoryList where label does not contain UPDATED_LABEL
        defaultProductCategoryShouldBeFound("label.doesNotContain=" + UPDATED_LABEL);
    }
