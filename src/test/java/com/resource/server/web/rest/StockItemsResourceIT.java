...
public class StockItemsResourceIT {
    ...
    private static final Float SMALLER_RECOMMENDED_RETAIL_PRICE = 1F - 1F;
    ...
    public void getAllStockItemsBySellStartDateIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the stockItemsList where sellStartDate is greater than or equal to DEFAULT_SELL_START_DATE
        defaultStockItemsShouldBeFound("sellStartDate.greaterThanOrEqual=" + DEFAULT_SELL_START_DATE);

        // Get all the stockItemsList where sellStartDate is greater than or equal to UPDATED_SELL_START_DATE
        defaultStockItemsShouldNotBeFound("sellStartDate.greaterThanOrEqual=" + UPDATED_SELL_START_DATE);
    }

    @Test
    @Transactional
    public void getAllStockItemsBySellStartDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        stockItemsRepository.saveAndFlush(stockItems);

        // Get all the stockItemsList where sellStartDate is less than or equal to DEFAULT_SELL_START_DATE
        defaultStockItemsShouldBeFound("sellStartDate.lessThanOrEqual=" + DEFAULT_SELL_START_DATE);

        // Get all the stockItemsList where sellStartDate is less than or equal to SMALLER_SELL_START_DATE
        defaultStockItemsShouldNotBeFound("sellStartDate.lessThanOrEqual=" + SMALLER_SELL_START_DATE);
    }
    ...
    public void getAllStockItemsBySellStartDateIsLessThanSomething() throws Exception {
        ...
        // Get all the stockItemsList where sellStartDate is less than DEFAULT_SELL_START_DATE
        defaultStockItemsShouldNotBeFound("sellStartDate.lessThan=" + DEFAULT_SELL_START_DATE);

        // Get all the stockItemsList where sellStartDate is less than UPDATED_SELL_START_DATE
        defaultStockItemsShouldBeFound("sellStartDate.lessThan=" + UPDATED_SELL_START_DATE);
    }

    @Test
    @Transactional
    public void getAllStockItemsBySellStartDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        stockItemsRepository.saveAndFlush(stockItems);

        // Get all the stockItemsList where sellStartDate is greater than DEFAULT_SELL_START_DATE
        defaultStockItemsShouldNotBeFound("sellStartDate.greaterThan=" + DEFAULT_SELL_START_DATE);

        // Get all the stockItemsList where sellStartDate is greater than SMALLER_SELL_START_DATE
        defaultStockItemsShouldBeFound("sellStartDate.greaterThan=" + SMALLER_SELL_START_DATE);
    }
    ...
    public void getAllStockItemsBySellEndDateIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the stockItemsList where sellEndDate is greater than or equal to DEFAULT_SELL_END_DATE
        defaultStockItemsShouldBeFound("sellEndDate.greaterThanOrEqual=" + DEFAULT_SELL_END_DATE);

        // Get all the stockItemsList where sellEndDate is greater than or equal to UPDATED_SELL_END_DATE
        defaultStockItemsShouldNotBeFound("sellEndDate.greaterThanOrEqual=" + UPDATED_SELL_END_DATE);
    }

    @Test
    @Transactional
    public void getAllStockItemsBySellEndDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        stockItemsRepository.saveAndFlush(stockItems);

        // Get all the stockItemsList where sellEndDate is less than or equal to DEFAULT_SELL_END_DATE
        defaultStockItemsShouldBeFound("sellEndDate.lessThanOrEqual=" + DEFAULT_SELL_END_DATE);

        // Get all the stockItemsList where sellEndDate is less than or equal to SMALLER_SELL_END_DATE
        defaultStockItemsShouldNotBeFound("sellEndDate.lessThanOrEqual=" + SMALLER_SELL_END_DATE);
    }
    ...
    public void getAllStockItemsBySellEndDateIsLessThanSomething() throws Exception {
        ...
        // Get all the stockItemsList where sellEndDate is less than DEFAULT_SELL_END_DATE
        defaultStockItemsShouldNotBeFound("sellEndDate.lessThan=" + DEFAULT_SELL_END_DATE);

        // Get all the stockItemsList where sellEndDate is less than UPDATED_SELL_END_DATE
        defaultStockItemsShouldBeFound("sellEndDate.lessThan=" + UPDATED_SELL_END_DATE);
    }

    @Test
    @Transactional
    public void getAllStockItemsBySellEndDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        stockItemsRepository.saveAndFlush(stockItems);

        // Get all the stockItemsList where sellEndDate is greater than DEFAULT_SELL_END_DATE
        defaultStockItemsShouldNotBeFound("sellEndDate.greaterThan=" + DEFAULT_SELL_END_DATE);

        // Get all the stockItemsList where sellEndDate is greater than SMALLER_SELL_END_DATE
        defaultStockItemsShouldBeFound("sellEndDate.greaterThan=" + SMALLER_SELL_END_DATE);
    }
    ...
    @Test
    @Transactional
    public void getAllStockItemsByLastEditedWhenIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        stockItemsRepository.saveAndFlush(stockItems);

        // Get all the stockItemsList where lastEditedWhen is greater than or equal to DEFAULT_LAST_EDITED_WHEN
        defaultStockItemsShouldBeFound("lastEditedWhen.greaterThanOrEqual=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the stockItemsList where lastEditedWhen is greater than or equal to UPDATED_LAST_EDITED_WHEN
        defaultStockItemsShouldNotBeFound("lastEditedWhen.greaterThanOrEqual=" + UPDATED_LAST_EDITED_WHEN);
    }

    @Test
    @Transactional
    public void getAllStockItemsByLastEditedWhenIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        stockItemsRepository.saveAndFlush(stockItems);

        // Get all the stockItemsList where lastEditedWhen is less than or equal to DEFAULT_LAST_EDITED_WHEN
        defaultStockItemsShouldBeFound("lastEditedWhen.lessThanOrEqual=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the stockItemsList where lastEditedWhen is less than or equal to SMALLER_LAST_EDITED_WHEN
        defaultStockItemsShouldNotBeFound("lastEditedWhen.lessThanOrEqual=" + SMALLER_LAST_EDITED_WHEN);
    }

    @Test
    @Transactional
    public void getAllStockItemsByLastEditedWhenIsLessThanSomething() throws Exception {
        // Initialize the database
        stockItemsRepository.saveAndFlush(stockItems);

        // Get all the stockItemsList where lastEditedWhen is less than DEFAULT_LAST_EDITED_WHEN
        defaultStockItemsShouldNotBeFound("lastEditedWhen.lessThan=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the stockItemsList where lastEditedWhen is less than UPDATED_LAST_EDITED_WHEN
        defaultStockItemsShouldBeFound("lastEditedWhen.lessThan=" + UPDATED_LAST_EDITED_WHEN);
    }

    @Test
    @Transactional
    public void getAllStockItemsByLastEditedWhenIsGreaterThanSomething() throws Exception {
        // Initialize the database
        stockItemsRepository.saveAndFlush(stockItems);

        // Get all the stockItemsList where lastEditedWhen is greater than DEFAULT_LAST_EDITED_WHEN
        defaultStockItemsShouldNotBeFound("lastEditedWhen.greaterThan=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the stockItemsList where lastEditedWhen is greater than SMALLER_LAST_EDITED_WHEN
        defaultStockItemsShouldBeFound("lastEditedWhen.greaterThan=" + SMALLER_LAST_EDITED_WHEN);
    }
