...
import com.resource.server.service.dto.CustomerTransactionsCriteria;
import com.resource.server.service.CustomerTransactionsQueryService;
...
public class CustomerTransactionsResourceIT {
    ...
    @Test
    @Transactional
    public void getAllCustomerTransactionsByTransactionDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        customerTransactionsRepository.saveAndFlush(customerTransactions);

        // Get all the customerTransactionsList where transactionDate is greater than or equal to DEFAULT_TRANSACTION_DATE
        defaultCustomerTransactionsShouldBeFound("transactionDate.greaterThanOrEqual=" + DEFAULT_TRANSACTION_DATE);

        // Get all the customerTransactionsList where transactionDate is greater than or equal to UPDATED_TRANSACTION_DATE
        defaultCustomerTransactionsShouldNotBeFound("transactionDate.greaterThanOrEqual=" + UPDATED_TRANSACTION_DATE);
    }

    @Test
    @Transactional
    public void getAllCustomerTransactionsByTransactionDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        customerTransactionsRepository.saveAndFlush(customerTransactions);

        // Get all the customerTransactionsList where transactionDate is less than or equal to DEFAULT_TRANSACTION_DATE
        defaultCustomerTransactionsShouldBeFound("transactionDate.lessThanOrEqual=" + DEFAULT_TRANSACTION_DATE);

        // Get all the customerTransactionsList where transactionDate is less than or equal to SMALLER_TRANSACTION_DATE
        defaultCustomerTransactionsShouldNotBeFound("transactionDate.lessThanOrEqual=" + SMALLER_TRANSACTION_DATE);
    }

    @Test
    @Transactional
    public void getAllCustomerTransactionsByTransactionDateIsLessThanSomething() throws Exception {
        // Initialize the database
        customerTransactionsRepository.saveAndFlush(customerTransactions);

        // Get all the customerTransactionsList where transactionDate is less than DEFAULT_TRANSACTION_DATE
        defaultCustomerTransactionsShouldNotBeFound("transactionDate.lessThan=" + DEFAULT_TRANSACTION_DATE);

        // Get all the customerTransactionsList where transactionDate is less than UPDATED_TRANSACTION_DATE
        defaultCustomerTransactionsShouldBeFound("transactionDate.lessThan=" + UPDATED_TRANSACTION_DATE);
    }

    @Test
    @Transactional
    public void getAllCustomerTransactionsByTransactionDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        customerTransactionsRepository.saveAndFlush(customerTransactions);

        // Get all the customerTransactionsList where transactionDate is greater than DEFAULT_TRANSACTION_DATE
        defaultCustomerTransactionsShouldNotBeFound("transactionDate.greaterThan=" + DEFAULT_TRANSACTION_DATE);

        // Get all the customerTransactionsList where transactionDate is greater than SMALLER_TRANSACTION_DATE
        defaultCustomerTransactionsShouldBeFound("transactionDate.greaterThan=" + SMALLER_TRANSACTION_DATE);
    }
    ...
    @Test
    @Transactional
    public void getAllCustomerTransactionsByFinalizationDateIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        customerTransactionsRepository.saveAndFlush(customerTransactions);

        // Get all the customerTransactionsList where finalizationDate is greater than or equal to DEFAULT_FINALIZATION_DATE
        defaultCustomerTransactionsShouldBeFound("finalizationDate.greaterThanOrEqual=" + DEFAULT_FINALIZATION_DATE);

        // Get all the customerTransactionsList where finalizationDate is greater than or equal to UPDATED_FINALIZATION_DATE
        defaultCustomerTransactionsShouldNotBeFound("finalizationDate.greaterThanOrEqual=" + UPDATED_FINALIZATION_DATE);
    }

    @Test
    @Transactional
    public void getAllCustomerTransactionsByFinalizationDateIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        customerTransactionsRepository.saveAndFlush(customerTransactions);

        // Get all the customerTransactionsList where finalizationDate is less than or equal to DEFAULT_FINALIZATION_DATE
        defaultCustomerTransactionsShouldBeFound("finalizationDate.lessThanOrEqual=" + DEFAULT_FINALIZATION_DATE);

        // Get all the customerTransactionsList where finalizationDate is less than or equal to SMALLER_FINALIZATION_DATE
        defaultCustomerTransactionsShouldNotBeFound("finalizationDate.lessThanOrEqual=" + SMALLER_FINALIZATION_DATE);
    }

    @Test
    @Transactional
    public void getAllCustomerTransactionsByFinalizationDateIsLessThanSomething() throws Exception {
        // Initialize the database
        customerTransactionsRepository.saveAndFlush(customerTransactions);

        // Get all the customerTransactionsList where finalizationDate is less than DEFAULT_FINALIZATION_DATE
        defaultCustomerTransactionsShouldNotBeFound("finalizationDate.lessThan=" + DEFAULT_FINALIZATION_DATE);

        // Get all the customerTransactionsList where finalizationDate is less than UPDATED_FINALIZATION_DATE
        defaultCustomerTransactionsShouldBeFound("finalizationDate.lessThan=" + UPDATED_FINALIZATION_DATE);
    }

    @Test
    @Transactional
    public void getAllCustomerTransactionsByFinalizationDateIsGreaterThanSomething() throws Exception {
        // Initialize the database
        customerTransactionsRepository.saveAndFlush(customerTransactions);

        // Get all the customerTransactionsList where finalizationDate is greater than DEFAULT_FINALIZATION_DATE
        defaultCustomerTransactionsShouldNotBeFound("finalizationDate.greaterThan=" + DEFAULT_FINALIZATION_DATE);

        // Get all the customerTransactionsList where finalizationDate is greater than SMALLER_FINALIZATION_DATE
        defaultCustomerTransactionsShouldBeFound("finalizationDate.greaterThan=" + SMALLER_FINALIZATION_DATE);
    }
    ...
    @Test
    @Transactional
    public void getAllCustomerTransactionsByLastEditedWhenIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        customerTransactionsRepository.saveAndFlush(customerTransactions);

        // Get all the customerTransactionsList where lastEditedWhen is greater than or equal to DEFAULT_LAST_EDITED_WHEN
        defaultCustomerTransactionsShouldBeFound("lastEditedWhen.greaterThanOrEqual=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the customerTransactionsList where lastEditedWhen is greater than or equal to UPDATED_LAST_EDITED_WHEN
        defaultCustomerTransactionsShouldNotBeFound("lastEditedWhen.greaterThanOrEqual=" + UPDATED_LAST_EDITED_WHEN);
    }

    @Test
    @Transactional
    public void getAllCustomerTransactionsByLastEditedWhenIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        customerTransactionsRepository.saveAndFlush(customerTransactions);

        // Get all the customerTransactionsList where lastEditedWhen is less than or equal to DEFAULT_LAST_EDITED_WHEN
        defaultCustomerTransactionsShouldBeFound("lastEditedWhen.lessThanOrEqual=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the customerTransactionsList where lastEditedWhen is less than or equal to SMALLER_LAST_EDITED_WHEN
        defaultCustomerTransactionsShouldNotBeFound("lastEditedWhen.lessThanOrEqual=" + SMALLER_LAST_EDITED_WHEN);
    }

    @Test
    @Transactional
    public void getAllCustomerTransactionsByLastEditedWhenIsLessThanSomething() throws Exception {
        // Initialize the database
        customerTransactionsRepository.saveAndFlush(customerTransactions);

        // Get all the customerTransactionsList where lastEditedWhen is less than DEFAULT_LAST_EDITED_WHEN
        defaultCustomerTransactionsShouldNotBeFound("lastEditedWhen.lessThan=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the customerTransactionsList where lastEditedWhen is less than UPDATED_LAST_EDITED_WHEN
        defaultCustomerTransactionsShouldBeFound("lastEditedWhen.lessThan=" + UPDATED_LAST_EDITED_WHEN);
    }

    @Test
    @Transactional
    public void getAllCustomerTransactionsByLastEditedWhenIsGreaterThanSomething() throws Exception {
        // Initialize the database
        customerTransactionsRepository.saveAndFlush(customerTransactions);

        // Get all the customerTransactionsList where lastEditedWhen is greater than DEFAULT_LAST_EDITED_WHEN
        defaultCustomerTransactionsShouldNotBeFound("lastEditedWhen.greaterThan=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the customerTransactionsList where lastEditedWhen is greater than SMALLER_LAST_EDITED_WHEN
        defaultCustomerTransactionsShouldBeFound("lastEditedWhen.greaterThan=" + SMALLER_LAST_EDITED_WHEN);
    }
