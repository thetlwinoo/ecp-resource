...
import com.resource.server.service.dto.PaymentTransactionsCriteria;
import com.resource.server.service.PaymentTransactionsQueryService;
...
public class PaymentTransactionsResourceIT {
    ...
    @Test
    @Transactional
    public void getAllPaymentTransactionsByLastEditedWhenIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        paymentTransactionsRepository.saveAndFlush(paymentTransactions);

        // Get all the paymentTransactionsList where lastEditedWhen is greater than or equal to DEFAULT_LAST_EDITED_WHEN
        defaultPaymentTransactionsShouldBeFound("lastEditedWhen.greaterThanOrEqual=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the paymentTransactionsList where lastEditedWhen is greater than or equal to UPDATED_LAST_EDITED_WHEN
        defaultPaymentTransactionsShouldNotBeFound("lastEditedWhen.greaterThanOrEqual=" + UPDATED_LAST_EDITED_WHEN);
    }

    @Test
    @Transactional
    public void getAllPaymentTransactionsByLastEditedWhenIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        paymentTransactionsRepository.saveAndFlush(paymentTransactions);

        // Get all the paymentTransactionsList where lastEditedWhen is less than or equal to DEFAULT_LAST_EDITED_WHEN
        defaultPaymentTransactionsShouldBeFound("lastEditedWhen.lessThanOrEqual=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the paymentTransactionsList where lastEditedWhen is less than or equal to SMALLER_LAST_EDITED_WHEN
        defaultPaymentTransactionsShouldNotBeFound("lastEditedWhen.lessThanOrEqual=" + SMALLER_LAST_EDITED_WHEN);
    }

    @Test
    @Transactional
    public void getAllPaymentTransactionsByLastEditedWhenIsLessThanSomething() throws Exception {
        // Initialize the database
        paymentTransactionsRepository.saveAndFlush(paymentTransactions);

        // Get all the paymentTransactionsList where lastEditedWhen is less than DEFAULT_LAST_EDITED_WHEN
        defaultPaymentTransactionsShouldNotBeFound("lastEditedWhen.lessThan=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the paymentTransactionsList where lastEditedWhen is less than UPDATED_LAST_EDITED_WHEN
        defaultPaymentTransactionsShouldBeFound("lastEditedWhen.lessThan=" + UPDATED_LAST_EDITED_WHEN);
    }

    @Test
    @Transactional
    public void getAllPaymentTransactionsByLastEditedWhenIsGreaterThanSomething() throws Exception {
        // Initialize the database
        paymentTransactionsRepository.saveAndFlush(paymentTransactions);

        // Get all the paymentTransactionsList where lastEditedWhen is greater than DEFAULT_LAST_EDITED_WHEN
        defaultPaymentTransactionsShouldNotBeFound("lastEditedWhen.greaterThan=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the paymentTransactionsList where lastEditedWhen is greater than SMALLER_LAST_EDITED_WHEN
        defaultPaymentTransactionsShouldBeFound("lastEditedWhen.greaterThan=" + SMALLER_LAST_EDITED_WHEN);
    }
