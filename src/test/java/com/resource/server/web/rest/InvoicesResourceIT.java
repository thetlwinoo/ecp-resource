...
import com.resource.server.service.dto.InvoicesCriteria;
import com.resource.server.service.InvoicesQueryService;
...
public class InvoicesResourceIT {
    ...
    @Test
    @Transactional
    public void getAllInvoicesByLastEditedWhenIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        invoicesRepository.saveAndFlush(invoices);

        // Get all the invoicesList where lastEditedWhen is greater than or equal to DEFAULT_LAST_EDITED_WHEN
        defaultInvoicesShouldBeFound("lastEditedWhen.greaterThanOrEqual=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the invoicesList where lastEditedWhen is greater than or equal to UPDATED_LAST_EDITED_WHEN
        defaultInvoicesShouldNotBeFound("lastEditedWhen.greaterThanOrEqual=" + UPDATED_LAST_EDITED_WHEN);
    }

    @Test
    @Transactional
    public void getAllInvoicesByLastEditedWhenIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        invoicesRepository.saveAndFlush(invoices);

        // Get all the invoicesList where lastEditedWhen is less than or equal to DEFAULT_LAST_EDITED_WHEN
        defaultInvoicesShouldBeFound("lastEditedWhen.lessThanOrEqual=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the invoicesList where lastEditedWhen is less than or equal to SMALLER_LAST_EDITED_WHEN
        defaultInvoicesShouldNotBeFound("lastEditedWhen.lessThanOrEqual=" + SMALLER_LAST_EDITED_WHEN);
    }

    @Test
    @Transactional
    public void getAllInvoicesByLastEditedWhenIsLessThanSomething() throws Exception {
        // Initialize the database
        invoicesRepository.saveAndFlush(invoices);

        // Get all the invoicesList where lastEditedWhen is less than DEFAULT_LAST_EDITED_WHEN
        defaultInvoicesShouldNotBeFound("lastEditedWhen.lessThan=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the invoicesList where lastEditedWhen is less than UPDATED_LAST_EDITED_WHEN
        defaultInvoicesShouldBeFound("lastEditedWhen.lessThan=" + UPDATED_LAST_EDITED_WHEN);
    }

    @Test
    @Transactional
    public void getAllInvoicesByLastEditedWhenIsGreaterThanSomething() throws Exception {
        // Initialize the database
        invoicesRepository.saveAndFlush(invoices);

        // Get all the invoicesList where lastEditedWhen is greater than DEFAULT_LAST_EDITED_WHEN
        defaultInvoicesShouldNotBeFound("lastEditedWhen.greaterThan=" + DEFAULT_LAST_EDITED_WHEN);

        // Get all the invoicesList where lastEditedWhen is greater than SMALLER_LAST_EDITED_WHEN
        defaultInvoicesShouldBeFound("lastEditedWhen.greaterThan=" + SMALLER_LAST_EDITED_WHEN);
    }
